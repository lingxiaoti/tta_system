...
public class TtaApplication extends CommonApplication {

	private static Logger log = LoggerFactory.getLogger(TtaApplication.class);
	...
	public static void main(String[] args) {
		ApplicationContext context = SpringApplication.run(TtaApplication.class);
	...
	MultipartConfigElement multipartConfigElement() {
		...
		//String location = "/home/ttaprd/jars/data/temp";
