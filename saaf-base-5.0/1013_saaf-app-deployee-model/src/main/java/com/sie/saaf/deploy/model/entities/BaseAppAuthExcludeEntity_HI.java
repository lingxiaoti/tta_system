...
/**
 * BaseAppAuthExcludeEntity_HI Entity Object
 * Mon Aug 20 15:13:19 CST 2018  Auto Generate
 */
@Entity
@Table(name="base_app_auth_exclude")
public class BaseAppAuthExcludeEntity_HI {
	...
	@Id	
	@SequenceGenerator(name = "SEQ_BASE_APP_AUTH_EXCLUDE", sequenceName = "SEQ_BASE_APP_AUTH_EXCLUDE", allocationSize = 1)
	@GeneratedValue(generator = "SEQ_BASE_APP_AUTH_EXCLUDE", strategy = GenerationType.SEQUENCE)	
