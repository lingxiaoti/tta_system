...
public class TransSampleListener implements MessageListener {
    ...
    public void onMessage(Message message) {
        ...
        try {
            ...
            //执行带事务注解的方法
            demoServer.saveTransMessageConsumer(redisMessageContentBean.getMessageIndex(),JSON.parseObject(redisMessageContentBean.getMessageBody(), DemoEntity_HI.class));
            log.info("MQ消费者执行完成");
        }catch (Exception e){
