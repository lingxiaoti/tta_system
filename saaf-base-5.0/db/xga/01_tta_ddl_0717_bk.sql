...
Source Server         : 华为云_139.159.224.135
...
comment on column BASE_USERS.user_id
  is '用户Id';
comment on column BASE_USERS.delete_flag
  is '是否删除（0：未删除；1：已删除）';
comment on column BASE_USERS.start_date
  is '生效日期';
comment on column BASE_USERS.end_date
  is '失效日期';
comment on column BASE_USERS.order_no
  is '排序号';
comment on column BASE_USERS.creation_date
  is '创建日期';
comment on column BASE_USERS.created_by
  is '创建人';
comment on column BASE_USERS.last_updated_by
  is '更新人';
comment on column BASE_USERS.last_update_date
  is '更新日期';
comment on column BASE_USERS.version_num
  is '版本号';
comment on column BASE_USERS.service_store_id
  is '所属服务店id';
comment on column BASE_USERS.data_type
  is '数据类型';
comment on column BASE_USERS.group_code
  is 'GROUP_CODE';
comment on column BASE_USERS.group_name
  is 'GROUP_NAME';
...
alter table BASE_USERS
  add constraint PK_BASE_USERS primary key (USER_ID)
  using index
  tablespace TTA_DATA
  pctfree 10
  initrans 2
...
FEEDEPT_DETAIL_ID NUMBER NOT NULL ,
FEEDEPT_ID NUMBER NOT NULL ,
FEEDEPT_LINE_ID NUMBER NOT NULL ,
DEPT_CODE VARCHAR2(50 BYTE) NULL ,
DEPT_DESC VARCHAR2(200 BYTE) NULL ,
CREATION_DATE DATE DEFAULT SYSDATE  NULL ,
CREATED_BY NUMBER NULL ,
LAST_UPDATED_BY NUMBER NULL ,
LAST_UPDATE_DATE DATE DEFAULT SYSDATE  NULL ,
...
;
COMMENT ON TABLE TTA_FEE_DEPT_DETAIL IS '单位（明细）';
COMMENT ON COLUMN TTA_FEE_DEPT_DETAIL.FEEDEPT_DETAIL_ID IS '明细ID';
COMMENT ON COLUMN TTA_FEE_DEPT_DETAIL.FEEDEPT_ID IS '头表ID';
COMMENT ON COLUMN TTA_FEE_DEPT_DETAIL.FEEDEPT_LINE_ID IS '行表ID';
COMMENT ON COLUMN TTA_FEE_DEPT_DETAIL.DEPT_CODE IS '部门编码';
COMMENT ON COLUMN TTA_FEE_DEPT_DETAIL.DEPT_DESC IS '部门名称';
COMMENT ON COLUMN TTA_FEE_DEPT_DETAIL.UNIT IS '单位';
COMMENT ON COLUMN TTA_FEE_DEPT_DETAIL.STANDARD_VALUE IS '标准值';
...
FEEDEPT_ID NUMBER NOT NULL ,
YEAR_CODE VARCHAR2(50 BYTE) NOT NULL ,
ACCORD_TYPE VARCHAR2(10 BYTE) NOT NULL ,
...
IS_ALERT VARCHAR2(10 BYTE) NULL ,
VERSION_CODE VARCHAR2(20 BYTE) NULL ,
REMARK VARCHAR2(1500 BYTE) NULL 
)
LOGGING
NOCOMPRESS
...
;
COMMENT ON TABLE TTA_FEE_DEPT_HEADER IS '部门协定标准（头）';
COMMENT ON COLUMN TTA_FEE_DEPT_HEADER.YEAR_CODE IS '年度';
COMMENT ON COLUMN TTA_FEE_DEPT_HEADER.ACCORD_TYPE IS '协定标准类型';
COMMENT ON COLUMN TTA_FEE_DEPT_HEADER.STATUS IS '状态';
COMMENT ON COLUMN TTA_FEE_DEPT_HEADER.APPROVE_DATE IS '审批时间';
COMMENT ON COLUMN TTA_FEE_DEPT_HEADER.SOURCE_FEE_ID IS '来源ID';
COMMENT ON COLUMN TTA_FEE_DEPT_HEADER.IS_ALERT IS '是否变更';
COMMENT ON COLUMN TTA_FEE_DEPT_HEADER.VERSION_CODE IS '版本号';
COMMENT ON COLUMN TTA_FEE_DEPT_HEADER.REMARK IS '备注';
...
(
  ...
  item_desc_cn      VARCHAR2(800) not null,
  ...
  last_update_login INTEGER,
  version_num       INTEGER,
  vendor_nbr        VARCHAR2(30),
  vendor_name       VARCHAR2(130),
  start_date        DATE,
  end_date          DATE,
  sm_tc_atd         VARCHAR2(50),
  ...
  uda50             VARCHAR2(800),
  uda51             VARCHAR2(800),
  source_system     VARCHAR2(800),
  source_code       VARCHAR2(800),
  pack_size         VARCHAR2(50),
  remark            VARCHAR2(800),
  create_date       DATE
);
...
comment on column TTA_ITEM.vendor_name
  is '供应商名称';
comment on column TTA_ITEM.brand_code
  is 'BRAND';
...
NEWBREED_SET_ID NUMBER NOT NULL ,
BREED_NAME VARCHAR2(100 BYTE) NULL ,
IS_EFFECTIVE VARCHAR2(2 BYTE) NULL ,
CREATION_DATE DATE NULL ,
CREATED_BY NUMBER NULL ,
LAST_UPDATE_DATE DATE NULL ,
LAST_UPDATED_BY NUMBER NULL ,
...
;
COMMENT ON COLUMN TTA_NEWBREED_SET_HEADER.NEWBREED_SET_ID IS '新品种项目设置ID';
COMMENT ON COLUMN TTA_NEWBREED_SET_HEADER.BREED_NAME IS '名称 NB_NAME 0.所有新品 1.进口新品 2.非独家新品 3.独家新品';
COMMENT ON COLUMN TTA_NEWBREED_SET_HEADER.IS_EFFECTIVE IS '是否生效';
COMMENT ON COLUMN TTA_NEWBREED_SET_HEADER.CREATION_DATE IS '创建时间';
COMMENT ON COLUMN TTA_NEWBREED_SET_HEADER.CREATED_BY IS '创建人';
COMMENT ON COLUMN TTA_NEWBREED_SET_HEADER.LAST_UPDATE_DATE IS '更新时间';
COMMENT ON COLUMN TTA_NEWBREED_SET_HEADER.LAST_UPDATED_BY IS '更新人';
COMMENT ON COLUMN TTA_NEWBREED_SET_HEADER.LAST_UPDATE_LOGIN IS '最后登录ID';
COMMENT ON COLUMN TTA_NEWBREED_SET_HEADER.DELETE_FLAG IS '删除标识';
COMMENT ON COLUMN TTA_NEWBREED_SET_HEADER.VERSION_NUM IS '版本号';
...
NEWBREED_SET_LINE_ID NUMBER NOT NULL ,
RANGE VARCHAR2(100 BYTE) NULL ,
UNIT VARCHAR2(100 BYTE) NULL ,
STANDARD NUMBER NULL ,
IS_ENABLE VARCHAR2(2 BYTE) NULL ,
CREATION_DATE DATE NULL ,
CREATED_BY NUMBER NULL ,
LAST_UPDATE_DATE DATE NULL ,
LAST_UPDATED_BY NUMBER NULL ,
...
DELETE_FLAG NUMBER DEFAULT 0  NULL ,
VERSION_NUM NUMBER DEFAULT 0  NULL ,
NEWBREED_SET_ID NUMBER NULL ,
PURCHASE_TYPE VARCHAR2(100 BYTE) NULL ,
STORE_TYPE VARCHAR2(100 BYTE) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON COLUMN TTA_NEWBREED_SET_LINE.NEWBREED_SET_LINE_ID IS '新品种项目设置ID';
COMMENT ON COLUMN TTA_NEWBREED_SET_LINE.RANGE IS '收取范围  NB_RANGE 1. 按全国 2.按地区 3.按店铺类型';
COMMENT ON COLUMN TTA_NEWBREED_SET_LINE.UNIT IS '单位';
COMMENT ON COLUMN TTA_NEWBREED_SET_LINE.STANDARD IS '标准值';
COMMENT ON COLUMN TTA_NEWBREED_SET_LINE.IS_ENABLE IS '是否启用';
COMMENT ON COLUMN TTA_NEWBREED_SET_LINE.CREATION_DATE IS '创建时间';
COMMENT ON COLUMN TTA_NEWBREED_SET_LINE.CREATED_BY IS '创建人';
COMMENT ON COLUMN TTA_NEWBREED_SET_LINE.LAST_UPDATE_DATE IS '更新时间';
COMMENT ON COLUMN TTA_NEWBREED_SET_LINE.LAST_UPDATED_BY IS '更新人';
COMMENT ON COLUMN TTA_NEWBREED_SET_LINE.LAST_UPDATE_LOGIN IS '最后登录ID';
COMMENT ON COLUMN TTA_NEWBREED_SET_LINE.DELETE_FLAG IS '删除标识';
COMMENT ON COLUMN TTA_NEWBREED_SET_LINE.VERSION_NUM IS '版本号';
COMMENT ON COLUMN TTA_NEWBREED_SET_LINE.NEWBREED_SET_ID IS '头ID';
COMMENT ON COLUMN TTA_NEWBREED_SET_LINE.PURCHASE_TYPE IS '采购类型 1、寄售经仓（CVM）2、非寄售经仓（NON-CVM）';
COMMENT ON COLUMN TTA_NEWBREED_SET_LINE.STORE_TYPE IS '店铺类型 1、Super Star 2、Star 3、Anchor 4、Basic 5、Baby 6、Emryo';
...
H  与 B
健与美';
COMMENT ON COLUMN TTA_OI_BILL_LINE.HBI001_SUM_MONEY IS 'H  与 B
健与美
Total';
...
(
  ...
  major_dept_desc    VARCHAR2(100),
  sale_type          VARCHAR2(20),
  major_dept_id      INTEGER,
  major_dept_code    VARCHAR2(30)
)
tablespace TTA_DATA
  pctfree 10
  initrans 1
...
comment on column TTA_PROPOSAL_HEADER.origin_proposal_id
  is '变更后原有proposal_id';
comment on column TTA_PROPOSAL_HEADER.major_dept_desc
  is '主部门';
comment on column TTA_PROPOSAL_HEADER.sale_type
  is '销售方式';
comment on column TTA_PROPOSAL_HEADER.major_dept_id
  is '主部门id';
comment on column TTA_PROPOSAL_HEADER.major_dept_code
  is '主部门编号';
-- Create/Recreate indexes
create index VENDOR_NBR_U1 on TTA_PROPOSAL_HEADER (VENDOR_NBR)
  tablespace TTA_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
(
  terms_h_id           INTEGER not null,
  agreement_edition    VARCHAR2(50) not null,
  vendor_nbr           VARCHAR2(30) not null,
  vendor_desc          VARCHAR2(230) not null,
  dept_code            VARCHAR2(30) not null,
  dept_desc            VARCHAR2(230) not null,
  brand_code           VARCHAR2(30),
  brand_cn             VARCHAR2(230) not null,
  brand_en             VARCHAR2(230) not null,
  sales_type           VARCHAR2(10),
  consignment_discount NUMBER,
  fcs_purchse          NUMBER,
  gp                   NUMBER,
  warehouse_code       VARCHAR2(30),
  warehouse_desc       VARCHAR2(230),
  pay_days             INTEGER,
  sales_up_scale       NUMBER,
  buyer_code           VARCHAR2(30),
  invoice_type         VARCHAR2(30),
  red_ticket_scale     NUMBER,
  fcs_sales            NUMBER,
  is_return            CHAR(1),
  beoi_tax             VARCHAR2(30),
  source_proposal      VARCHAR2(50),
  terms_version        VARCHAR2(20),
  remark               VARCHAR2(2030),
  creation_date        DATE default SYSDATE,
  created_by           INTEGER,
  last_updated_by      INTEGER,
  ...
  last_update_login    INTEGER,
  version_num          INTEGER,
  terms_class          VARCHAR2(130),
  proposal_id          INTEGER,
  sales_area           VARCHAR2(200)
)
tablespace TTA_DATA
  pctfree 10
  initrans 1
...
-- Add comments to the columns
comment on column TTA_PROPOSAL_TERMS_HEADER.agreement_edition
  is '合同版本';
comment on column TTA_PROPOSAL_TERMS_HEADER.vendor_nbr
  is '供应商编号';
comment on column TTA_PROPOSAL_TERMS_HEADER.vendor_desc
  is '供应商';
comment on column TTA_PROPOSAL_TERMS_HEADER.dept_desc
  is '部门';
comment on column TTA_PROPOSAL_TERMS_HEADER.brand_code
  is '品牌';
comment on column TTA_PROPOSAL_TERMS_HEADER.sales_type
  is '销售方式';
comment on column TTA_PROPOSAL_TERMS_HEADER.consignment_discount
  is '寄售折扣';
comment on column TTA_PROPOSAL_TERMS_HEADER.warehouse_code
  is '仓库编码';
comment on column TTA_PROPOSAL_TERMS_HEADER.warehouse_desc
  is '仓库描述';
comment on column TTA_PROPOSAL_TERMS_HEADER.pay_days
  is '付款期（天数）';
comment on column TTA_PROPOSAL_TERMS_HEADER.sales_up_scale
  is '营改增加成比例';
comment on column TTA_PROPOSAL_TERMS_HEADER.buyer_code
  is 'Buyer Code（工号）';
comment on column TTA_PROPOSAL_TERMS_HEADER.invoice_type
  is 'Invoice Type发票类型';
comment on column TTA_PROPOSAL_TERMS_HEADER.red_ticket_scale
  is '红票收益屈臣氏分配占比';
comment on column TTA_PROPOSAL_TERMS_HEADER.is_return
  is '是否可退货';
comment on column TTA_PROPOSAL_TERMS_HEADER.beoi_tax
  is 'BEOI Tax税率';
comment on column TTA_PROPOSAL_TERMS_HEADER.source_proposal
  is '原Proposal单号';
comment on column TTA_PROPOSAL_TERMS_HEADER.terms_version
  is '条款版本号';
comment on column TTA_PROPOSAL_TERMS_HEADER.proposal_id
  is 'proposal头表ID';
comment on column TTA_PROPOSAL_TERMS_HEADER.sales_area
  is '销售区域';
-- Create/Recreate indexes
create index TERMS_H_U1 on TTA_PROPOSAL_TERMS_HEADER (DEPT_CODE)
  tablespace TTA_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
-- Create/Recreate primary, unique and foreign key constraints
alter table TTA_PROPOSAL_TERMS_HEADER
  add constraint PK_TERMS_H_ID primary key (TERMS_H_ID)
  using index
  tablespace TTA_DATA
  pctfree 10
  initrans 2
...
(
  terms_l_id          INTEGER not null,
  terms_h_id          INTEGER not null,
  income_type         VARCHAR2(200),
  y_terms             VARCHAR2(200),
  collect_type        VARCHAR2(20),
  reference_standard  NUMBER,
  y_year              VARCHAR2(50),
  qty                 NUMBER,
  unit                VARCHAR2(50),
  terms_system        VARCHAR2(50),
  fee_notax           NUMBER,
  fee_intas           NUMBER,
  ...
  clause_tree_id      INTEGER,
  order_no            VARCHAR2(200) not null,
  y_terms_en          VARCHAR2(200) not null,
  old_clause_id       INTEGER,
  business_version    VARCHAR2(200),
  oi_type             VARCHAR2(200) not null,
  old_clause_tree_id2 NUMBER
)
tablespace TTA_DATA
  pctfree 10
  initrans 1
...
-- Add comments to the table
comment on table TTA_PROPOSAL_TERMS_LINE
  is 'TTA TERMS 条款明细';
-- Add comments to the columns
comment on column TTA_PROPOSAL_TERMS_LINE.income_type
  is '收入类型';
comment on column TTA_PROPOSAL_TERMS_LINE.y_terms
  is 'Y年度条款';
comment on column TTA_PROPOSAL_TERMS_LINE.collect_type
  is '收取方式';
comment on column TTA_PROPOSAL_TERMS_LINE.reference_standard
  is '参考标准';
comment on column TTA_PROPOSAL_TERMS_LINE.y_year
  is '年度TTA';
comment on column TTA_PROPOSAL_TERMS_LINE.qty
  is '数量';
comment on column TTA_PROPOSAL_TERMS_LINE.unit
  is '单位';
comment on column TTA_PROPOSAL_TERMS_LINE.terms_system
  is 'Y年度条款（System）';
comment on column TTA_PROPOSAL_TERMS_LINE.fee_notax
  is '年度费用预估（不含税）（含加税）';
comment on column TTA_PROPOSAL_TERMS_LINE.fee_intas
  is '年度费用预告（含税）（含加成）';
comment on column TTA_PROPOSAL_TERMS_LINE.terms_code
  is '条款编号';
comment on column TTA_PROPOSAL_TERMS_LINE.clause_id
  is '条款名目ID';
comment on column TTA_PROPOSAL_TERMS_LINE.clause_tree_id
  is '条款收取方式ID';
comment on column TTA_PROPOSAL_TERMS_LINE.order_no
  is '排序号';
comment on column TTA_PROPOSAL_TERMS_LINE.y_terms_en
  is '条款EN';
comment on column TTA_PROPOSAL_TERMS_LINE.old_clause_id
  is '往年条款ID ';
comment on column TTA_PROPOSAL_TERMS_LINE.business_version
  is '版本号';
comment on column TTA_PROPOSAL_TERMS_LINE.old_clause_tree_id2
  is '往年收取方式ID';
-- Create/Recreate indexes
create index PK_TERMS_L_CLA on TTA_PROPOSAL_TERMS_LINE (CLAUSE_ID)
  tablespace TTA_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
create index PK_TERMS_L_PRO on TTA_PROPOSAL_TERMS_LINE (PROPOSAL_ID)
  tablespace TTA_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
create index PK_TERMS_L_U2 on TTA_PROPOSAL_TERMS_LINE (CLAUSE_TREE_ID)
  tablespace TTA_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
-- Create/Recreate primary, unique and foreign key constraints
alter table TTA_PROPOSAL_TERMS_LINE
  add constraint PK_TERMS_L_ID primary key (TERMS_L_ID)
  using index
  tablespace TTA_DATA
  pctfree 10
  initrans 2
...
alter table TTA_PROPOSAL_TERMS_LINE
  add constraint U_TERMS_L_ID unique (TERMS_H_ID, INCOME_TYPE, Y_TERMS)
  using index
  tablespace TTA_DATA
  pctfree 10
  initrans 2
...
-- ----------------------------
-- Table structure for TTA_PURCHASE_IN
-- ----------------------------
...
;
COMMENT ON TABLE TTA_PURCHASE_IN IS 'PURCHASE数据';
COMMENT ON COLUMN TTA_PURCHASE_IN.PURCHASE_ID IS '主键';
COMMENT ON COLUMN TTA_PURCHASE_IN.VENDOR_NBR IS '供应商编号';
COMMENT ON COLUMN TTA_PURCHASE_IN.VENDOR_NAME IS '供应商名称';
COMMENT ON COLUMN TTA_PURCHASE_IN.YEAR_MONTH_DAY IS '收货日期';
COMMENT ON COLUMN TTA_PURCHASE_IN.LOCATION IS '仓库地址';
COMMENT ON COLUMN TTA_PURCHASE_IN.ITEM_NBR IS 'ITEM编号';
COMMENT ON COLUMN TTA_PURCHASE_IN.RECEIVING_QTY IS '收货数量';
COMMENT ON COLUMN TTA_PURCHASE_IN.RECEIVING_AMOUNT IS '收货金额';
COMMENT ON COLUMN TTA_PURCHASE_IN.CANCEL_RECEIVING_QTY IS '采购退货数量';
COMMENT ON COLUMN TTA_PURCHASE_IN.CANCEL_RECEIVING_AMT IS '采购退货金额';
COMMENT ON COLUMN TTA_PURCHASE_IN.CURRENCY IS '币种';
COMMENT ON COLUMN TTA_PURCHASE_IN.PURCHASE_TYPE IS '采购模式';
COMMENT ON COLUMN TTA_PURCHASE_IN.ADDRESS_TYPE IS '地点类型';
COMMENT ON COLUMN TTA_PURCHASE_IN.PO_NBR IS 'PO单号';
COMMENT ON COLUMN TTA_PURCHASE_IN.IS_DSD IS 'IS_DSD';
COMMENT ON COLUMN TTA_PURCHASE_IN.STORE IS 'STORE';
COMMENT ON COLUMN TTA_PURCHASE_IN.VERSION_NUM IS '版本号';
...
REL_SUPPLIER_CODE VARCHAR2(50 BYTE) NOT NULL ,
REL_SUPPLIER_NAME VARCHAR2(230 BYTE) NOT NULL ,
...
;
COMMENT ON TABLE TTA_REL_SUPPLIER IS '关联供应商表';
COMMENT ON COLUMN TTA_REL_SUPPLIER.REL_SUPPLIER_ID IS '主键ID';
COMMENT ON COLUMN TTA_REL_SUPPLIER.REL_SUPPLIER_CODE IS '供应商编号';
COMMENT ON COLUMN TTA_REL_SUPPLIER.REL_SUPPLIER_NAME IS '供应商名';
COMMENT ON COLUMN TTA_REL_SUPPLIER.REL_ID IS '外键，tta_base_supplier表id';
COMMENT ON COLUMN TTA_REL_SUPPLIER.STATUS IS '状态';
COMMENT ON COLUMN TTA_REL_SUPPLIER.CREATION_DATE IS '创建日期';
COMMENT ON COLUMN TTA_REL_SUPPLIER.CREATED_BY IS '创建人';
COMMENT ON COLUMN TTA_REL_SUPPLIER.LAST_UPDATED_BY IS '更新人';
COMMENT ON COLUMN TTA_REL_SUPPLIER.LAST_UPDATE_DATE IS '更新日期';
COMMENT ON COLUMN TTA_REL_SUPPLIER.LAST_UPDATE_LOGIN IS '登录人';
COMMENT ON COLUMN TTA_REL_SUPPLIER.VERSION_NUM IS '版本号';
...
-- ----------------------------
-- Table structure for TTA_SHOP_MARKET
-- ----------------------------
DROP TABLE TTA_SHOP_MARKET;
CREATE TABLE TTA_SHOP_MARKET (
SHOP_MARKET_ID NUMBER NOT NULL ,
...
SHOP_LEVEL VARCHAR2(2) NOT NULL ,
OPEN_SHOP DATE NOT NULL ,
CLOSE_SHOP DATE NULL ,
...
;
COMMENT ON TABLE TTA_SHOP_MARKET IS '店铺对应市场';
COMMENT ON COLUMN TTA_SHOP_MARKET.SHOP_MARKET_ID IS '主键';
COMMENT ON COLUMN TTA_SHOP_MARKET.SHOP_NAME IS '店铺';
COMMENT ON COLUMN TTA_SHOP_MARKET.CITY_NAME IS '城市';
COMMENT ON COLUMN TTA_SHOP_MARKET.PROVINCE_NAME IS '省份';
COMMENT ON COLUMN TTA_SHOP_MARKET.MARKET_NAME IS '市场';
COMMENT ON COLUMN TTA_SHOP_MARKET.AREA_NAME IS '区域';
COMMENT ON COLUMN TTA_SHOP_MARKET.CHANNEL IS '渠道 0:线下 1:线上';
COMMENT ON COLUMN TTA_SHOP_MARKET.SHOP_LEVEL IS '店铺级别';
COMMENT ON COLUMN TTA_SHOP_MARKET.OPEN_SHOP IS '店铺开店时间';
COMMENT ON COLUMN TTA_SHOP_MARKET.CLOSE_SHOP IS '店铺关店时间';
COMMENT ON COLUMN TTA_SHOP_MARKET.WAREHOUSE_CODE IS '仓库编号';
COMMENT ON COLUMN TTA_SHOP_MARKET.WAREHOUSE_NAME IS '仓库名称';
...
TEAM_FRAMEWORK_ID NUMBER NOT NULL ,
FRAME_CODE VARCHAR2(50 BYTE) NULL ,
YEAR NUMBER NOT NULL ,
FRAME_NAME VARCHAR2(50 BYTE) NULL ,
BILL_STATUS VARCHAR2(20 BYTE) NOT NULL ,
BUSINESS_VERSION VARCHAR2(20 BYTE) NOT NULL ,
PASS_DATE DATE NULL ,
EFFECTIVE_DATE DATE NULL ,
EXPIRATION_DATE DATE NULL ,
CREATED_BY NUMBER NULL ,
...
;
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER.FRAME_CODE IS '框架编码，暂时采用年度';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER.YEAR IS '年度';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER.FRAME_NAME IS '框架名称';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER.BILL_STATUS IS '单据状态（1制作中、2待审批、3审批通过）';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER.BUSINESS_VERSION IS '条款框架版本号';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER.PASS_DATE IS '审批通过时间';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER.EFFECTIVE_DATE IS '版本生效日期';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER.EXPIRATION_DATE IS '版本失效日期';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER.CREATED_BY IS '创建人';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER.LAST_UPDATED_BY IS '更新人';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER.LAST_UPDATE_DATE IS '更新日期';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER.CREATION_DATE IS '创建日期';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER.LAST_UPDATE_LOGIN IS '登录人';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER.VERSION_NUM IS '版本号';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER.DELETE_FLAG IS '是否删除（0：未删除；1：已删除）';
...
TEAM_FRAMEWORK_ID NUMBER NOT NULL ,
FRAME_CODE VARCHAR2(50 BYTE) NOT NULL ,
YEAR NUMBER NOT NULL ,
FRAME_NAME VARCHAR2(50 BYTE) NULL ,
BILL_STATUS VARCHAR2(20 BYTE) NOT NULL ,
BUSINESS_VERSION VARCHAR2(20 BYTE) NOT NULL ,
...
EXPIRATION_DATE DATE NULL ,
RESOUCE_ID NUMBER NULL ,
RESOUCE_BUSINESS_VERSION VARCHAR2(20 BYTE) NULL ,
CREATED_BY NUMBER NULL ,
LAST_UPDATED_BY NUMBER NULL ,
LAST_UPDATE_DATE DATE NULL ,
CREATION_DATE DATE NULL ,
...
;
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER_H.FRAME_CODE IS '框架编码，暂时采用年度';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER_H.YEAR IS '年度';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER_H.FRAME_NAME IS '框架名称';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER_H.BILL_STATUS IS '单据状态（1制作中、2待审批、3审批通过）';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER_H.BUSINESS_VERSION IS '条款框架版本号';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER_H.PASS_DATE IS '审批通过时间';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER_H.EFFECTIVE_DATE IS '版本生效日期';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER_H.EXPIRATION_DATE IS '版本失效日期';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER_H.RESOUCE_ID IS '来源版本Id，对应复制原纪录id';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER_H.RESOUCE_BUSINESS_VERSION IS '来源版本号，对应复制原纪录版本号';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER_H.CREATED_BY IS '创建人';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER_H.LAST_UPDATED_BY IS '更新人';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER_H.LAST_UPDATE_DATE IS '更新日期';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER_H.CREATION_DATE IS '创建日期';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER_H.LAST_UPDATE_LOGIN IS '登录人';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER_H.VERSION_NUM IS '版本号';
COMMENT ON COLUMN TTA_TERMS_FRAME_HEADER_H.DELETE_FLAG IS '是否删除（0：未删除；1：已删除）';
...
USER_GROUP_DEPT_BRAND_ID NUMBER NOT NULL ,
USER_ID NUMBER NULL ,
"GROUP" VARCHAR2(200 BYTE) NULL ,
GROUP_DESC VARCHAR2(500 BYTE) NULL ,
DEPT VARCHAR2(200 BYTE) NULL ,
DEPT_DESC VARCHAR2(500 BYTE) NULL ,
BRAND_CODE VARCHAR2(200 BYTE) NULL ,
BRAND_CN VARCHAR2(500 BYTE) NULL ,
BRAND_EN VARCHAR2(500 BYTE) NULL ,
VERSION_NUM NUMBER NULL ,
CREATION_DATE DATE DEFAULT SYSDATE  NOT NULL ,
CREATED_BY NUMBER DEFAULT -1  NOT NULL ,
LAST_UPDATED_BY NUMBER DEFAULT -1  NOT NULL ,
...
;
COMMENT ON TABLE TTA_USER_GROUP_DEPT_BRAND IS ' user group dept brand 权限表';
COMMENT ON COLUMN TTA_USER_GROUP_DEPT_BRAND.USER_GROUP_DEPT_BRAND_ID IS '主键';
COMMENT ON COLUMN TTA_USER_GROUP_DEPT_BRAND.USER_ID IS '外键，引用base_user表主键';

-- ----------------------------
-- Table structure for TTA_VENDOR_IN
-- ----------------------------
...
;
COMMENT ON TABLE TTA_VENDOR_IN IS '供应商信息接口';
COMMENT ON COLUMN TTA_VENDOR_IN.VENDOR_ID IS '主键ID';
COMMENT ON COLUMN TTA_VENDOR_IN.VENDOR_NBR IS '供应商编号';
COMMENT ON COLUMN TTA_VENDOR_IN.VENDOR_NAME IS '供应商名称';
COMMENT ON COLUMN TTA_VENDOR_IN.STATUS IS '状态';
COMMENT ON COLUMN TTA_VENDOR_IN.CREATION_DATE IS '创建日期';
COMMENT ON COLUMN TTA_VENDOR_IN.CREATED_BY IS '创建人';
COMMENT ON COLUMN TTA_VENDOR_IN.LAST_UPDATED_BY IS '更新人';
COMMENT ON COLUMN TTA_VENDOR_IN.LAST_UPDATE_DATE IS '更新日期';
COMMENT ON COLUMN TTA_VENDOR_IN.LAST_UPDATE_LOGIN IS '登录人';
COMMENT ON COLUMN TTA_VENDOR_IN.VERSION_NUM IS '版本号';
...
-- ----------------------------
CREATE OR REPLACE VIEW TTA_CONTRACT_LINE_V AS

select tc.contract_l_id,
       tc.contract_h_id,
       tc.vendor_code,
       tc.vendor_name,
       tc.org_code,
       ...
       tc.dept_desc,
          u1.user_name last_updated_name,
   u2.user_name created_name
        from  tta_contract_line tc,
              base_users u1,
      base_users u2
   where  tc.last_updated_by = u1.user_id(+)
   and tc.created_by = u2.user_id(+);
...
-- ----------------------------
CREATE OR REPLACE FORCE VIEW TTA_FEE_DEPT_H_V AS 
...
select
 ...
 ,nvl(tpth.dept_desc,tsp.owner_group_name)         "DEPT_DESC"
 ,nvl(tpth.dept_code,tsp.owner_group)         "DEPT_CODE"
...
,tpo.sale_type               "SALES_TYPE"
,tpth.BEOI_TAX                  "BEOI_TAX"
,tpth.TERMS_CLASS                 "TERMS_CLASS"
,nvl(tpo.is_terms_confirm,'N') is_terms_confirm
,nvl(tpth.BRAND_CN,(select listagg(trs.rel_brand_name, '/') within group(order by trs.rel_brand_name)
from tta_supplier ts,
     tta_rel_supplier_brand trs
where
     ts.supplier_code = tpo.vendor_nbr
     and ts.supplier_id = trs.rel_id
     and ts.status = 'B' ))                    "BRAND_CN"
...
,OldTpo.Sale_Type                "OLD_SALES_TYPE"
...
left join tta_proposal_terms_header tpth on tpo.proposal_id = tpth.proposal_id
left join tta_supplier tsp on tpo.vendor_nbr = tsp.supplier_code
left join tta_proposal_header oldTpo on  tpo.vendor_nbr = oldTpo.Vendor_Nbr and tpo.proposal_year = oldTpo.Proposal_Year+1
                                        and oldTpo.Status = 'C'
left join  tta_proposal_terms_header  OldTpth on oldTpo.Proposal_Id = OldTpth.Proposal_Id
left join  tta_brandpln_header tbh on tpo.proposal_id = tbh.proposal_id
left join  base_users bu  on tpth.created_by = bu.user_id
left join  base_person bp on bu.person_id = bp.person_id
left join base_users buOld on OldTpth.created_by = buOld.user_id
left join base_person bpOld on   buOld.person_id = bpOld.person_id
...
-- ----------------------------
CREATE OR REPLACE FORCE VIEW TTA_REL_SUPPLIER_BRAND_V AS 
...
t.WIN_TOP_SUPPLIER,t.KB_SCORECARD,t.GROUP_name,t.dept_name
  from
...
-- ----------------------------
CREATE OR REPLACE FORCE VIEW TTA_REL_SUPPLIER_V AS 
...
CREATE OR REPLACE VIEW TTA_SUPPLIER_IS_V AS
SELECT t."SUPPLIER_ID",t."SUPPLIER_CODE",t."SUPPLIER_NAME",
t."STATUS",t."IS_LATENT",t."OWNER_DEPT",
t."CREATION_DATE",t."CREATED_BY",
t."LAST_UPDATED_BY",t."LAST_UPDATE_DATE",
t."LAST_UPDATE_LOGIN",t."VERSION_NUM",
t."OWNER_GROUP",t."CONTRACT_OUTPUT",
t.owner_group_name,
t."PURCHASE_MODE",t."PROPOSAL_BRAND_GROUP",
t."FORMAL_CODE",t."FORMAL_NAME",
   T.DEPT_NAME DEPT_NAME,
   lookup.meaning status_name,
   u1.user_name last_updated_name,
   u2.user_name created_name,
   decode(nvl(tphh.vendor_nbr,'-1'),'-1','New_Vendor','Existing_Vendor') isNew,
   decode(nvl(tphh.vendor_nbr,'-1'),'-1','是','否') isNewName
   FROM Tta_Supplier t,
 --  base_department bd,
    (select lookup_type,lookup_code,meaning
        from base_lookup_values where lookup_type='SUPPLIER_STATUS' and enabled_flag='Y'
      ...
      (select vendor_nbr from tta_proposal_header  tph where tph.status ='C'group by tph.vendor_nbr) tphh,
      base_users u1,
      base_users u2
   where
   -- t.owner_dept = bd.department_code(+)

   t.supplier_code = tphh.vendor_nbr(+)
   and t.status =lookup.lookup_code(+)
   and t.last_updated_by = u1.user_id(+)
   and t.created_by = u2.user_id(+)
;
...
-- ----------------------------
-- Sequence structure for SEQ_TTA_ITEM
-- ----------------------------
DROP SEQUENCE SEQ_TTA_ITEM;
CREATE SEQUENCE SEQ_TTA_ITEM
 INCREMENT BY 1
 MINVALUE 1
 MAXVALUE 9999999999999999999999999999
 START WITH 1
...
-- ----------------------------
-- Sequence structure for SEQ_TTA_PURCHASE_IN
-- ----------------------------
DROP SEQUENCE SEQ_TTA_PURCHASE_IN;
CREATE SEQUENCE SEQ_TTA_PURCHASE_IN
 INCREMENT BY 1
 MINVALUE 1
 MAXVALUE 9999999999999999999999999999
 START WITH 1
...
-- ----------------------------
-- Sequence structure for SEQ_TTA_SHOP_MARKET
-- ----------------------------
DROP SEQUENCE SEQ_TTA_SHOP_MARKET;
CREATE SEQUENCE SEQ_TTA_SHOP_MARKET
 INCREMENT BY 1
 MINVALUE 1
 MAXVALUE 9999999999999999999999999999
 START WITH 1
...
-- ----------------------------
-- Indexes structure for table TTA_ITEM
-- ----------------------------

-- ----------------------------
-- Checks structure for table TTA_ITEM
-- ----------------------------
ALTER TABLE TTA_ITEM ADD CHECK (ITEM_ID IS NOT NULL);
ALTER TABLE TTA_ITEM ADD CHECK (ITEM_NBR IS NOT NULL);
ALTER TABLE TTA_ITEM ADD CHECK (ITEM_DESC_CN IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table TTA_ITEM
-- ----------------------------
ALTER TABLE TTA_ITEM ADD PRIMARY KEY (ITEM_ID);
...
-- ----------------------------
-- Indexes structure for table TTA_PURCHASE_IN
-- ----------------------------

-- ----------------------------
-- Checks structure for table TTA_PURCHASE_IN
-- ----------------------------
ALTER TABLE TTA_PURCHASE_IN ADD CHECK (VENDOR_NBR IS NOT NULL);
ALTER TABLE TTA_PURCHASE_IN ADD CHECK (VENDOR_NAME IS NOT NULL);
ALTER TABLE TTA_PURCHASE_IN ADD CHECK (YEAR_MONTH_DAY IS NOT NULL);
ALTER TABLE TTA_PURCHASE_IN ADD CHECK (IS_DSD IS NOT NULL);
ALTER TABLE TTA_PURCHASE_IN ADD CHECK (CREATION_DATE IS NOT NULL);
ALTER TABLE TTA_PURCHASE_IN ADD CHECK (CREATED_BY IS NOT NULL);
ALTER TABLE TTA_PURCHASE_IN ADD CHECK (LAST_UPDATED_BY IS NOT NULL);
ALTER TABLE TTA_PURCHASE_IN ADD CHECK (LAST_UPDATE_DATE IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table TTA_PURCHASE_IN
-- ----------------------------
ALTER TABLE TTA_PURCHASE_IN ADD PRIMARY KEY (PURCHASE_ID);
...
-- ----------------------------
-- Indexes structure for table TTA_SHOP_MARKET
-- ----------------------------

-- ----------------------------
-- Checks structure for table TTA_SHOP_MARKET
-- ----------------------------
ALTER TABLE TTA_SHOP_MARKET ADD CHECK (SHOP_MARKET_ID IS NOT NULL);
ALTER TABLE TTA_SHOP_MARKET ADD CHECK (SHOP_NAME IS NOT NULL);
ALTER TABLE TTA_SHOP_MARKET ADD CHECK (CITY_NAME IS NOT NULL);
ALTER TABLE TTA_SHOP_MARKET ADD CHECK (PROVINCE_NAME IS NOT NULL);
ALTER TABLE TTA_SHOP_MARKET ADD CHECK (MARKET_NAME IS NOT NULL);
ALTER TABLE TTA_SHOP_MARKET ADD CHECK (AREA_NAME IS NOT NULL);
ALTER TABLE TTA_SHOP_MARKET ADD CHECK (CHANNEL IS NOT NULL);
ALTER TABLE TTA_SHOP_MARKET ADD CHECK (SHOP_LEVEL IS NOT NULL);
ALTER TABLE TTA_SHOP_MARKET ADD CHECK (OPEN_SHOP IS NOT NULL);
ALTER TABLE TTA_SHOP_MARKET ADD CHECK (WAREHOUSE_CODE IS NOT NULL);
ALTER TABLE TTA_SHOP_MARKET ADD CHECK (WAREHOUSE_NAME IS NOT NULL);
ALTER TABLE TTA_SHOP_MARKET ADD CHECK (CREATION_DATE IS NOT NULL);
ALTER TABLE TTA_SHOP_MARKET ADD CHECK (LAST_UPDATE_DATE IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table TTA_SHOP_MARKET
-- ----------------------------
ALTER TABLE TTA_SHOP_MARKET ADD PRIMARY KEY (SHOP_MARKET_ID);
