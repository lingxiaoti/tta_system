...
/**
 * PlmDeptClassEntity_HI Entity Object
 * Wed Oct 23 15:32:20 CST 2019  Auto Generate
 */
@Entity
@Table(name="PLM_DEPT_CLASS")
public class PlmDeptClassEntity_HI {
	...
	@Id	
	@SequenceGenerator(name="plmDeptClassEntity_HISeqGener", sequenceName="SEQ_PLM_DEPT_CLASS", allocationSize=1, initialValue=1)
	@GeneratedValue(generator="plmDeptClassEntity_HISeqGener",strategy=GenerationType.SEQUENCE)	
	@Column(name="plm_dept_class_id", nullable=false, length=22)	
