...
/**
 * PlmMotherCompanyEntity_HI Entity Object Thu Oct 31 15:07:24 CST 2019 Auto
 * Generate
 */
@Entity
@Table(name = "PLM_MOTHER_COMPANY")
public class PlmMotherCompanyEntity_HI {
	...
	@Column(name = "uda_id", nullable = false, length = 22)
	...
	@Column(name = "uda_value", nullable = false, length = 22)
	...
	@Id
	@SequenceGenerator(name = "plmMotherCompanyEntity_HISeqGener", sequenceName = "SEQ_PLM_MOTHER_COMPANY", allocationSize = 1, initialValue = 1)
	@GeneratedValue(generator = "plmMotherCompanyEntity_HISeqGener", strategy = GenerationType.SEQUENCE)
	@Column(name = "plm_mother_company_id", nullable = false, length = 22)
	...
	@Column(name = "plm_mother_company_name", nullable = true, length = 200)
