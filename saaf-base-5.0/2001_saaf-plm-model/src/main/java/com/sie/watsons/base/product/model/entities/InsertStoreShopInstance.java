...
public class InsertStoreShopInstance implements Runnable {
	...
	public InsertStoreShopInstance(List<VmiShopEntity_HI_RO2> datajson,
			JSONObject params, SessionFactory sessionFactory,
			PlmProductStoreEntity_HI storeobj) {
