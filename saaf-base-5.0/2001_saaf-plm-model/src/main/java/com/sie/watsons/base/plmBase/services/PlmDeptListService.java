...
@RestController
@RequestMapping("/plmDeptListService")
public class PlmDeptListService extends CommonAbstractService {
	private static final Logger LOGGER = LoggerFactory
			.getLogger(PlmDeptListService.class);
	@Autowired
	private IPlmDeptList plmDeptListServer;

	public PlmDeptListService() {
		super();
	}

	@Override
	public IBaseCommon getBaseCommonServer() {
		return this.plmDeptListServer;
	}
	 ...
	 * @return Pagination
	 */
	@RequestMapping(method = RequestMethod.POST, value = "findPlmDeptListInfo")
	public String findPlmDeptListInfo(
		...
		Pagination<PlmDeptListEntity_HI_RO> dataList = plmDeptListServer
				.findPlmDeptListInfo(queryParamJSON, pageIndex, pageRows);
	 ...
	 * @description 保存
	 **/
	@RequestMapping(method = RequestMethod.POST, value = "savePlmDeptListInfo")
	public String savePlmDeptListInfo(
		...
		try {
			...
			JSONObject jsonObject = (JSONObject) JSONObject
					.toJSON(plmDeptListServer.savePlmDeptListInfo(parseObject));
