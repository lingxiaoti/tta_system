...
/**
 * PlmSalesAreaEntity_HI Entity Object
 * Wed Nov 06 11:32:36 CST 2019  Auto Generate
 */
@Entity
@Table(name="PLM_SALES_AREA")
public class PlmSalesAreaEntity_HI {
	...
	@Id	
	@SequenceGenerator(name="plmSalesAreaEntity_HISeqGener", sequenceName="SEQ_PLM_SALES_AREA", allocationSize=1, initialValue=1)
	@GeneratedValue(generator="plmSalesAreaEntity_HISeqGener",strategy=GenerationType.SEQUENCE)	
	@Column(name="plm_sales_area_id", nullable=false, length=22)	
