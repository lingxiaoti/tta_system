...
@RestController
@RequestMapping("/ttaRelSupplierBrandService")
public class TtaRelSupplierBrandService extends CommonAbstractService{
	private static final Logger LOGGER = LoggerFactory.getLogger(TtaRelSupplierBrandService.class);
	...
	public IBaseCommon getBaseCommonServer(){
		return this.ttaRelSupplierBrandServer;
	}
	...
	public String find(@RequestParam(required = false) String params,
		...
		try {
			...
			Pagination<TtaRelSupplierBrandEntity_HI_RO> result = ttaRelSupplierBrandServer.find(jsonObject, pageIndex, pageRows);
	...
	public String saveOrUpdate(@RequestParam(required = true) String params) {
		try {
			...
			TtaRelSupplierBrandEntity_HI instance = ttaRelSupplierBrandServer.saveOrUpdate(jsonObject, userId);
	...
	public String delete(@RequestParam(required = false) String params) {
		try {
			...
			for (String pkId : ids) {
				ttaRelSupplierBrandServer.delete(Integer.parseInt(pkId));
			}
	...
	public String findById(String params) {
		try{
			JSONObject jsonObject = JSON.parseObject(params);
			TtaRelSupplierBrandEntity_HI_RO instance = ttaRelSupplierBrandServer.findByRoId(jsonObject);
			return SToolUtils.convertResultJSONObj("S", SUCCESS_MSG, 0, instance).toString();
