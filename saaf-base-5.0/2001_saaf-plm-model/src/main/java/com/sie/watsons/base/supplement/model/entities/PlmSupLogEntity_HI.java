 ...
 */
@Entity
@Table(name="PLM_SUP_LOG")
public class PlmSupLogEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "SEQ_PLM_SUP_LOG", sequenceName = "SEQ_PLM_SUP_LOG", allocationSize = 1)
	@Column(name="plm_sup_log_id", nullable=false, length=11)
	@GeneratedValue(generator = "SEQ_PLM_SUP_LOG", strategy = GenerationType.SEQUENCE)
