...
public class SFTPUtils {
    ...
    private static final String host = "10.82.24.173";
    private static final int port = 22;
    private static final String username = "sieuat";
    private static final String password = "lLPsYmJlu5";
    public static final String directory = "/app/local/rms";
    ...
    public static SFTPUtils getInstance(String host, Integer port, String username, String password) {
        if (instance == null) {
            if (instance == null) {
                instance = new SFTPUtils();
                sftp = instance.connect(host, port, username, password);   //获取连接
