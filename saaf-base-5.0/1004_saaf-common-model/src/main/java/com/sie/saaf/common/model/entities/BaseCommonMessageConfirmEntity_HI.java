 ...
 */
@Entity
@Table(name = "base_common_message_confirm")
public class BaseCommonMessageConfirmEntity_HI {
	...
	@Id	
	@SequenceGenerator(name = "SEQ_BASE_COMMON_MESSAGE_CONFIR", sequenceName = "SEQ_BASE_COMMON_MESSAGE_CONFIR", allocationSize = 1)
  	@GeneratedValue(generator = "SEQ_BASE_COMMON_MESSAGE_CONFIR", strategy = GenerationType.SEQUENCE)
