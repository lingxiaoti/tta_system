...
public class DesUtil {
	...
	public static void main(String[] args) {
		try {
			String psw = DesUtil.AESEncode(CommonConstants.ENCODE_RULE, "Sieapp123@");
	...
	private static class GetCipher {
		...
		public GetCipher invoke() throws NoSuchAlgorithmException, NoSuchPaddingException, UnsupportedEncodingException {
