...
import com.sie.saaf.message.model.inter.server.MsgReceiveSqlServer;
...
/**
 * @author Chenzg
 * @createTime 2018-06-27 16:50
 * @description
 */
@RestController
@RequestMapping("/msgReceiveSqlService")
public class MsgReceiveSqlService extends CommonAbstractService {
    private static final Logger log = LoggerFactory.getLogger(MsgReceiveSqlService.class);

    @Autowired
    private MsgReceiveSqlServer msgReceiveSqlServer;

    @Autowired
    private static final Logger LOGGER = LoggerFactory.getLogger(MsgReceiveSqlService.class);

    @Override
    public IBaseCommon<?> getBaseCommonServer() {
        return this.msgReceiveSqlServer;
    }
    ...
    public String find(@RequestParam(required = false) String params,
        ...
        try {
            ...
            Pagination<MsgReceiveSqlEntity_HI> pagination = msgReceiveSqlServer.findReceiveSqlInfo(jsonObject, Integer.valueOf(Objects.toString(pageIndex, "-1")), Integer.valueOf(Objects.toString(pageRows, "-1")));
     ...
     *               }
     * @return
     * @description 接受对象为sql新增修改
     */
    @RequestMapping(method = RequestMethod.POST, value = "saveOrUpdate")
    public String saveOrUpdate(@RequestParam(required = true) String params) {
         try {
           JSONObject queryParamJSON = JSONObject.parseObject(params);
           SaafToolUtils.validateJsonParms(queryParamJSON, "sqlSentence", "sqlName");
           String msgSourceId = queryParamJSON.getString("msg_source_id");
    ...
    public String delete(@RequestParam(required = false) String params) {
        try {
            ...
            String result = msgReceiveSqlServer.deleteMsgReceiveSql(queryParamJSON, userId);
