...
/**
 * BaseAccessBasedataEntity_HI Entity Object
 * Sat Aug 04 16:37:35 CST 2018  Auto Generate
 */
@Entity
@Table(name = "base_access_basedata")
public class BaseAccessBasedataEntity_HI {
    ...
    @Id
    @SequenceGenerator(name = "SEQ_BASE_ACCESS_BASEDATA", sequenceName = "SEQ_BASE_ACCESS_BASEDATA", allocationSize = 1)
  	@GeneratedValue(generator = "SEQ_BASE_ACCESS_BASEDATA", strategy = GenerationType.SEQUENCE)
    ...
    @Column(name = "secondary_inventory_name", nullable = true, length = 30)
