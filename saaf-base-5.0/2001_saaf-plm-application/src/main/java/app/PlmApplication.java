...
public class PlmApplication extends CommonApplication {

	private static Logger log = LoggerFactory.getLogger(PlmApplication.class);
	...
	public static void main(String[] args) {
		ApplicationContext context = SpringApplication.run(PlmApplication.class);
