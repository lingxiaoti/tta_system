...
/**
 * MsgInstanceEntity_HI Entity Object
 * Thu Jun 07 09:20:21 CST 2018  Auto Generate
 */
@Entity
@Table(name = "msg_instance")
public class MsgInstanceEntity_HI {
    ...
    @Id
	@SequenceGenerator(name = "SEQ_MSG_INSTANCE", sequenceName = "SEQ_MSG_INSTANCE", allocationSize = 1)
	@GeneratedValue(generator = "SEQ_MSG_INSTANCE", strategy = GenerationType.SEQUENCE)
    @Column(name = "msg_instance_id", nullable = false, length = 20)
