...
@Component("ttaDeptFeeHeaderDAO_HI")
public class TtaDeptFeeHeaderDAO_HI extends BaseCommonDAO_HI<TtaDeptFeeHeaderEntity_HI> {
	private static final Logger LOGGER = LoggerFactory.getLogger(TtaDeptFeeHeaderDAO_HI.class);

	public TtaDeptFeeHeaderDAO_HI() {
		super();
	}

	//品牌计划计算
	public Map<String, Object> callDeptFeeHCount(Map<String, Object>  map ) throws Exception {
...
// 设置输入参数
					...
					call.setString(3, (String) map.get("accordType"));
