...
/**
 * TtaClauseTreeHEntity_HI Entity Object
 * Sun Jun 02 13:49:46 CST 2019  Auto Generate
 */
@Entity
@Table(name="Tta_Clause_Tree_h")
public class TtaClauseTreeHEntity_HI {
	...
	@Id
	@SequenceGenerator(name="SEQ_TTA_CLAUSE_TREE_H", sequenceName="SEQ_TTA_CLAUSE_TREE_H", allocationSize=1, initialValue=1)
	@GeneratedValue(generator="SEQ_TTA_CLAUSE_TREE_H",strategy=GenerationType.SEQUENCE)
	...
	@Column(name="clause_code", nullable=false, length=50)	
	...
	@Column(name="resouce_business_version", nullable=true, length=22)	
	...
	@Column(name="is_change", nullable=true, length=22)
	...
	@Column(name="is_global_fee", nullable=true, length=2)
