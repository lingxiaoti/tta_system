...
/**
 * TtaCollectTypeLineHEntity_HI Entity Object
 * Mon Jul 01 16:05:10 CST 2019  Auto Generate
 */
@Entity
@Table(name="tta_collect_type_line_h")
public class TtaCollectTypeLineHEntity_HI {
	...
	@Id
	@SequenceGenerator(name="SEQ_TTA_COLLECT_TYPE_LINE_H", sequenceName="SEQ_TTA_COLLECT_TYPE_LINE_H", allocationSize=1, initialValue=1)
	@GeneratedValue(generator="SEQ_TTA_COLLECT_TYPE_LINE_H",strategy=GenerationType.SEQUENCE)
	...
	@Column(name="resouce_id", nullable=false, length=22)
