...
/**
 * SaafTestQuestionnaireChoiceEntity_HI Entity Object
 * Sat Feb 16 14:17:43 CST 2019  Auto Generate
 */
@Entity
@Table(name="tta_test_questionnaire_choice")
public class SaafTestQuestionnaireChoiceEntity_HI {
	...
	private Integer originalQnChoiceId;//原始选项ID
	private String qnChoiceResult;//选项结果值
	...
	@Id
	@SequenceGenerator(name = "SEQ_TTA_TEST_QUESTIONNAIRE_CHO", sequenceName = "SEQ_TTA_TEST_QUESTIONNAIRE_CHO", allocationSize = 1)
	@GeneratedValue(generator = "SEQ_TTA_TEST_QUESTIONNAIRE_CHO", strategy = GenerationType.SEQUENCE)
	...
	public void setOriginalQnChoiceId(Integer originalQnChoiceId) {
		this.originalQnChoiceId = originalQnChoiceId;
	}

	@Column(name="original_qn_choice_id", nullable=true, length=11)
	public Integer getOriginalQnChoiceId() {
		return originalQnChoiceId;
	}
