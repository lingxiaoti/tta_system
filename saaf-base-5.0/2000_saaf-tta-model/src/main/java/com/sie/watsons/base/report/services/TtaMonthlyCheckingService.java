 ...
 */
@RestController
@RequestMapping("/ttaMonthlyCheckingService")
public class TtaMonthlyCheckingService extends CommonAbstractService {
    private static final Logger LOGGER = LoggerFactory.getLogger(TtaMonthlyCheckingService.class);
    ...
    public IBaseCommon getBaseCommonServer(){
        return this.ttaMonthlyCheckingServer;
    }
     ...
     * @return
     */
    @RequestMapping(method = RequestMethod.POST,value = "saveImportOsdMajorInfo")
    public String saveImportOsdMajorInfo(@RequestParam("file") MultipartFile file){
        try{
            String params = "";
            JSONObject jsonObject = parseObject(params);
            UserSessionBean sessionBean = getUserSessionBean();
            int size = ttaMonthlyCheckingServer.saveImportOsdMajorInfo(jsonObject,file,sessionBean);
    ...
    public String saveOrUpdateFind(@RequestParam(required = false) String params) {
        try {
            ...
            JSONObject jsonObject = ttaMonthlyCheckingServer.saveOrUpdateFind(paramsJSON, userId);
    ...
    public String findPagination(@RequestParam(required = false) String params,
        ...
        try{
            JSONObject jsonObject = parseObject(params);
            UserSessionBean sessionBean = getUserSessionBean();
            Pagination<TtaMonthlyCheckingEntity_HI_RO> result = ttaMonthlyCheckingServer.findOsdMajorInfo(jsonObject,pageIndex,pageRows,sessionBean);
    ...
    public String findNotExistPagination(@RequestParam(required = false) String params,
        ...
        try{
            JSONObject jsonObject = parseObject(params);
            UserSessionBean sessionBean = getUserSessionBean();
            Pagination<TtaMonthlyCheckingEntity_HI_RO> result = ttaMonthlyCheckingServer.findNotExist(jsonObject,pageIndex,pageRows);
            jsonObject = (JSONObject) JSON.toJSON(result);
            jsonObject.put(SToolUtils.STATUS,"S");
            jsonObject.put(SToolUtils.MSG,SUCCESS_MSG);
            return jsonObject.toString();
     ...
     * @return
     */
    @RequestMapping(method = RequestMethod.POST,value = "deleteImportOsdMajorInfo")
    public String deleteImportOsdMajorInfo(@RequestParam(required = false) String params){
        try{
            JSONObject jsonObject = parseObject(params);
            JSONObject result = ttaMonthlyCheckingServer.deleteImportOsdMajorInfo(jsonObject);
    ...
    public String saveOrUpdateAll(@RequestParam(required = true) String params) {
        try {
            ...
            List<TtaMonthlyCheckingEntity_HI> ttaTermsLEntity_his = ttaMonthlyCheckingServer.saveOrUpdateALL(jsonObject, userId );
    ...
    public String saveOrUpdateSplitALL(@RequestParam(required = true) String params) {
        try {
            ...
            List<TtaMonthlyCheckingEntity_HI> ttaTermsLEntity_his = ttaMonthlyCheckingServer.saveOrUpdateSplitALL(save, userId ,currentRow);
            return SToolUtils.convertResultJSONObj("S", SUCCESS_MSG, 0, ttaTermsLEntity_his).toString();
        } catch (IllegalArgumentException e) {
            LOGGER.warn(e.getMessage());
            return SToolUtils.convertResultJSONObj("E", e.getMessage(), 0, null).toString();
    ...
    public String saveOrUpdateTransferALL(@RequestParam(required = true) String params) {
        try {
            int userId = getSessionUserId();
            JSONObject jsonObject = parseObject(params);
            List<TtaMonthlyCheckingEntity_HI> ttaTermsLEntity_his = ttaMonthlyCheckingServer.saveOrUpdateTransferALL(jsonObject, userId );
            return SToolUtils.convertResultJSONObj("S", SUCCESS_MSG, 0, ttaTermsLEntity_his).toString();
        } catch (IllegalArgumentException e) {
            LOGGER.warn(e.getMessage());
            return SToolUtils.convertResultJSONObj("E", e.getMessage(), 0, null).toString();
     ...
     * @return
     */
    @RequestMapping(method = RequestMethod.POST, value = "findOsdMajorSummaryList")
    public String findOsdMajorSummaryList(@RequestParam(required = false) String params) {
        try {
            JSONObject queryParamJSON = parseObject(params);
            List findList = ttaMonthlyCheckingServer.findOsdMajorSummaryList(queryParamJSON);
    ...
    @RequestMapping(method = RequestMethod.POST, value = "findAmountList")
    public String findAmountList(@RequestParam(required = false) String params) {
        try {
            JSONObject queryParamJSON = parseObject(params);
            List findList = ttaMonthlyCheckingServer.findAmountList(queryParamJSON);
            return SToolUtils.convertResultJSONObj(SUCCESS_STATUS, "操作成功", findList.size(), findList).toString();
        } catch (Exception e) {
            LOGGER.error(e.getMessage(), e);
            return SToolUtils.convertResultJSONObj(ERROR_STATUS, e.getMessage(), 0, null).toString();
    ...
    public String findExportPagination(@RequestParam(required = false) String params,
        ...
        try{
            JSONObject jsonObject = parseObject(params);
            UserSessionBean sessionBean = getUserSessionBean();
            Pagination<TtaMonthlyCheckingEntity_HI_RO> result = ttaMonthlyCheckingServer.findExportPagination(jsonObject,pageIndex,pageRows);
            jsonObject = (JSONObject) JSON.toJSON(result);
            jsonObject.put(SToolUtils.STATUS,"S");
            jsonObject.put(SToolUtils.MSG,SUCCESS_MSG);
            return jsonObject.toString();
     ...
     */
    @RequestMapping(method = RequestMethod.POST,value = "updateImportOsdInfo")
    public String updateImportOSDInfo(@RequestParam("file") MultipartFile file){
        try{
            ...
            ttaMonthlyCheckingServer.updateImportOSDInfo(sessionBean, file);
     ...
     * 按照部门查询审批通过的DM流程信息
     */
    @RequestMapping(method = RequestMethod.POST,value = "findProcessSummaryOsdInfo")
    public String findProcessSummaryOsdInfo(@RequestParam(required = false) String params){
        try{
            JSONObject jsonObject = parseObject(params);
            UserSessionBean sessionBean = getUserSessionBean();
            Pagination<TtaMonthlyCheckingEntity_HI_RO> processSummaryOsdInfo = ttaMonthlyCheckingServer.findProcessSummaryOsdInfo(jsonObject, sessionBean);
    ...
    public String findProcessPagination(@RequestParam(required = false) String params,
        ...
        try{
            JSONObject jsonObject = parseObject(params);
            UserSessionBean sessionBean = getUserSessionBean();
            Pagination<TtaMonthlyCheckingEntity_HI_RO> result = ttaMonthlyCheckingServer.findProcessOsdInfo(jsonObject,pageIndex,pageRows,sessionBean);
            jsonObject = (JSONObject) JSON.toJSON(result);
            jsonObject.put(SToolUtils.STATUS,"S");
            jsonObject.put(SToolUtils.MSG,SUCCESS_MSG);
            return jsonObject.toString();
    ...
    public String findCheckGroupCount(@RequestParam(required = false) String params){
        try{
            JSONObject jsonObject = parseObject(params);
            UserSessionBean sessionBean = getUserSessionBean();
            ttaMonthlyCheckingServer.findCheckGroupCount(jsonObject,sessionBean);
