 ...
 */
@RestController
@RequestMapping("/ttaSalesSiteService")
public class TtaSalesSiteService extends CommonAbstractService {
    private static final Logger LOGGER = LoggerFactory.getLogger(TtaSalesSiteService.class);

    @Autowired
    private ITtaSalesSite ttaSalesSiteServer;
    ...
    public IBaseCommon getBaseCommonServer(){
        return this.ttaSalesSiteServer;
    }
     ...
     * @return
     */
    @RequestMapping(method = RequestMethod.POST,value = "saveImportOsdInfo")
    public String saveImportOsdInfo(@RequestParam("file") MultipartFile file){
        try{
            String params = "";
            JSONObject jsonObject = parseObject(params);
            UserSessionBean sessionBean = getUserSessionBean();
            int size = ttaSalesSiteServer.saveImportOsdInfo(jsonObject,file,sessionBean);
    ...
    public String findPagination(@RequestParam(required = false) String params,
        ...
        try{
            JSONObject jsonObject = parseObject(params);
            Pagination<TtaSalesSiteEntity_HI_RO> result = ttaSalesSiteServer.findOsdInfo(jsonObject,pageIndex,pageRows);
     ...
     * @return
     */
    @RequestMapping(method = RequestMethod.POST,value = "deleteImportOsdInfo")
    public String deleteImportOsdInfo(@RequestParam(required = false) String params){
        try{
            JSONObject jsonObject = parseObject(params);
            JSONObject result = ttaSalesSiteServer.deleteImportOsdInfo(jsonObject);
    ...
    public String saveOrUpdate(@RequestParam(required = true) String params) {
        try {
            ...
            TtaSalesSiteEntity_HI instance = ttaSalesSiteServer.saveOrUpdate(jsonObject, userId);
