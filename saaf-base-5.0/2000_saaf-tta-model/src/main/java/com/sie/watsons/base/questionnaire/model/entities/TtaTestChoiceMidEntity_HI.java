...
/**
 * TtaTestChoiceMidEntity_HI Entity Object
 * Fri Jun 14 12:15:28 CST 2019  Auto Generate
 */
@Entity
@Table(name="tta_test_choice_mid")
public class TtaTestChoiceMidEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "SEQ_TTA_TEST_CHOICE_MID", sequenceName = "SEQ_TTA_TEST_CHOICE_MID", allocationSize = 1)
	@GeneratedValue(generator = "SEQ_TTA_TEST_CHOICE_MID", strategy = GenerationType.SEQUENCE)
