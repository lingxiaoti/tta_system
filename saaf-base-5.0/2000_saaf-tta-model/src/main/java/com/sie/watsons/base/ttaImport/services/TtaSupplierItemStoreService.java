...
@RestController
@RequestMapping("/ttaSupplierItemStoreService")
public class TtaSupplierItemStoreService extends CommonAbstractService{
    private static final Logger LOGGER = LoggerFactory.getLogger(TtaSupplierItemStoreService.class);

    @Autowired
    private ITtaSupplierItemStore TtaSupplierItemStoreServer;

    @Override
    public IBaseCommon getBaseCommonServer(){
        return this.TtaSupplierItemStoreServer;
    }
    ...
    public String saveImportTaxInfo(@RequestParam("file") MultipartFile file){
        try{
            ...
            int size = TtaSupplierItemStoreServer.saveImportInfo(jsonObject,file);
    ...
    public String findPagination(@RequestParam(required = false) String params,
        ...
        try{
            JSONObject jsonObject = parseObject(params);
            Pagination<TtaSupplierItemStoreEntity_HI_RO> result = TtaSupplierItemStoreServer.findInfo(jsonObject,pageIndex,pageRows);
    ...
    public String deleteImportTaxInfo(@RequestParam(required = false) String params){
        try{
            JSONObject jsonObject = parseObject(params);
            JSONObject result = TtaSupplierItemStoreServer.deleteImportInfo(jsonObject);
