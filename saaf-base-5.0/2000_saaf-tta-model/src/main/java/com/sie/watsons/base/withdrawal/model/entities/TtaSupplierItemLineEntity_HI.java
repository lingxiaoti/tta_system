...
/**
 * TtaSupplierItemLineEntity_HI Entity Object
 * Sat Jul 20 17:29:31 CST 2019  Auto Generate
 * 供应商物料拆分记录表
 */
@Entity
@Table(name="tta_supplier_item_line")
public class TtaSupplierItemLineEntity_HI {
	private Integer supplierItemLineId;//主键
	...
	private String originalSupplierCode;//原始供应商编码
	private String originalSupplierName;//原始供应商名称
	...
	@Id
	@SequenceGenerator(name="seq_tta_supplier_item_line", sequenceName="seq_tta_supplier_item_line", allocationSize=1, initialValue=1)
	@GeneratedValue(generator="seq_tta_supplier_item_line",strategy=GenerationType.SEQUENCE)
	@Column(name="supplier_item_line_id", nullable=false, length=22)
	...
	@Column(name="split_condition", nullable=false, length=5)
	...
	@Column(name="original_supplier_code", nullable=true, length=50)
	...
	@Column(name="original_supplier_name", nullable=true, length=100)
