...
/**
 * TtaSoleNonStandarLineEntity_HI Entity Object
 * Mon Apr 20 15:57:41 CST 2020  Auto Generate
 */
@Entity
@Table(name="TTA_SOLE_NON_STANDAR_LINE")
public class TtaSoleNonStandarLineEntity_HI {
	...
	@Id
	@SequenceGenerator(name="SEQ_TTA_SOLE_NON_STANDAR_LINE", sequenceName="SEQ_TTA_SOLE_NON_STANDAR_LINE", allocationSize=1, initialValue=1)
	@GeneratedValue(generator="SEQ_TTA_SOLE_NON_STANDAR_LINE",strategy=GenerationType.SEQUENCE)
	@Column(name="sole_non_standar_line_id", nullable=true, length=22)	
