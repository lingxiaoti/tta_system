...
/**
 * SaafTestQuestionnaireHEntity_HI Entity Object
 * Sat Feb 16 14:17:41 CST 2019  Auto Generate
 */
@Entity
@Table(name="tta_test_questionnaire_header")
public class SaafTestQuestionnaireHEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "SEQ_TTA_TEST_QUESTIONNAIRE_H", sequenceName = "SEQ_TTA_TEST_QUESTIONNAIRE_H", allocationSize = 1)
	@GeneratedValue(generator = "SEQ_TTA_TEST_QUESTIONNAIRE_H", strategy = GenerationType.SEQUENCE)
	@Column(name="test_qn_head_id", nullable=false, length=11)	
