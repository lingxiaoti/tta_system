...
/**
 * TtaClauseTreeHEntity_HI_RO Entity Object
 * Sun Jun 02 13:49:46 CST 2019  Auto Generate
 */

public class TtaClauseTreeHEntity_HI_RO {

	/**
	 * 查询树级结构
	 */
	public static final String QUERY_CLAUSE_H_TREE_LIST ="select \n" +
			...
			"   ,code\n" +
			"   ,act.is_Leaf isLeaf\n" +
			"   from   tta_clause_tree_h act where nvl(act.delete_flag,0)=0";
	...
	public static final String QUERY_CLAUSE_TREE_ONE ="               select act.clause_id clauseId\n" +
			...
			"               ,get_clause_analysis_h(act.is_global_variable,act.expression_value) expressionValueText\n" +
			"               ,get_clause_analysis_h(act.is_global_tta,act.expression_value_tta)  expressionValueTtaText\n" +
			"               ,get_clause_analysis_h(act.is_global_fee,act.expression_value_fee)  expressionValueFeeText\n" +
					...
					"               from  tta_clause_tree_h act,\n" +
					"                    tta_clause_tree_h pact\n" +
    ...
    private Integer resouceBusinessVersion;
	...
	public void setResouceBusinessVersion(Integer resouceBusinessVersion) {
		this.resouceBusinessVersion = resouceBusinessVersion;
	}

	
	public Integer getResouceBusinessVersion() {
