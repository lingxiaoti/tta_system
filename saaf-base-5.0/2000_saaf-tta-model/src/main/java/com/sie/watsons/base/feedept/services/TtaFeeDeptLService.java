...
@RestController
@RequestMapping("/ttaFeeDeptLService")
public class TtaFeeDeptLService extends CommonAbstractService{
	private static final Logger LOGGER = LoggerFactory.getLogger(TtaFeeDeptLService.class);

	@Autowired
	private ITtaFeeDeptL ttaFeeDeptLServer;

	@Override
	public IBaseCommon getBaseCommonServer(){
		return this.ttaFeeDeptLServer;
	}
	...
	public String find(@RequestParam(required = false) String params,
		...
		try {
			...
			Pagination<TtaFeeDeptLEntity_HI_RO> result = ttaFeeDeptLServer.find(jsonObject, pageIndex, pageRows);
	...
	public String saveOrUpdate(@RequestParam(required = true) String params) {
		try {
			...
			TtaFeeDeptLEntity_HI instance = ttaFeeDeptLServer.saveOrUpdate(jsonObject, userId);
	...
	public String delete(@RequestParam(required = false) String params) {
		try {
			...
			for (String pkId : ids) {
				ttaFeeDeptLServer.delete(Integer.parseInt(pkId));
			}
	...
	public String findById(String params) {
		try{
			JSONObject jsonObject = JSON.parseObject(params);
			TtaFeeDeptLEntity_HI_RO instance = ttaFeeDeptLServer.findByRoId(jsonObject);
			return SToolUtils.convertResultJSONObj("S", SUCCESS_MSG, 0, instance).toString();
