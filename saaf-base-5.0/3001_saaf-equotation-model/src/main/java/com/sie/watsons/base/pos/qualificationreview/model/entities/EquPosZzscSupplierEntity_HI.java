...
/**
 * EquPosZzscSupplierEntity_HI Entity Object
 * Fri Sep 20 18:01:37 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_zzsc_supplier")
public class EquPosZzscSupplierEntity_HI {
	private Integer id;
	...
	@Id
	@SequenceGenerator(name = "equ_pos_zzsc_supplier_s", sequenceName = "equ_pos_zzsc_supplier_s", allocationSize = 1)
	@GeneratedValue(generator = "equ_pos_zzsc_supplier_s", strategy = GenerationType.SEQUENCE)
