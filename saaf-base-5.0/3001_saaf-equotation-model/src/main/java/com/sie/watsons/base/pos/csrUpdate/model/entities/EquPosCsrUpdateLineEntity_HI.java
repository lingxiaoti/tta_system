...
/**
 * EquPosCsrUpdateLineEntity_HI Entity Object
 * Sat Sep 21 10:08:25 CST 2019  Auto Generate
 */
@Entity
@Table(name="EQU_POS_CSR_UPDATE_LINE")
public class EquPosCsrUpdateLineEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "EQU_POS_CSR_UPDATE_LINE_SEQ", sequenceName = "EQU_POS_CSR_UPDATE_LINE_SEQ", allocationSize = 1)
	@GeneratedValue(generator = "EQU_POS_CSR_UPDATE_LINE_SEQ", strategy = GenerationType.SEQUENCE)
