...
/**
 * EquPosContractUpdateHeadEntity_HI Entity Object
 * Tue Sep 24 13:59:52 CST 2019  Auto Generate
 */
@Entity
@Table(name = "equ_pos_contract_update_head")
public class EquPosContractUpdateHeadEntity_HI {
    ...
    @Id
    @SequenceGenerator(name = "EQU_POS_CONTRACT_UPDATE_HEAD_S", sequenceName = "EQU_POS_CONTRACT_UPDATE_HEAD_S", allocationSize = 1)
    @GeneratedValue(generator = "EQU_POS_CONTRACT_UPDATE_HEAD_S", strategy = GenerationType.SEQUENCE)
