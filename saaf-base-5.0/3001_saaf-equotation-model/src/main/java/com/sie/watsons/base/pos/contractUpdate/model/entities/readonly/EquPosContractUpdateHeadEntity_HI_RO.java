package com.sie.watsons.base.pos.contractUpdate.model.entities.readonly;
...
/**
 * EquPosContractUpdateHeadEntity_HI_RO.QUERY_HEAD_SQL
 * EquPosContractUpdateHeadEntity_HI_RO Entity Object
 * Tue Sep 24 13:59:52 CST 2019  Auto Generate
 */

public class EquPosContractUpdateHeadEntity_HI_RO {
    ...
    public static final String Query_HEAD_ONLY = "SELECT t.UPDATE_HEAD_ID    updateHeadId\n" +
            ...
            "      ,t.dept_id           deptId\n" +
            "      ,t.remark            remark\n" +
            "FROM   equ_pos_contract_update_head t\n" +
            "WHERE  1 = 1";
    ...
    public List<EquPosContractUpdateLineEntity_HI_RO> getLineRoList() {
        return lineRoList;
    }

    public void setLineRoList(List<EquPosContractUpdateLineEntity_HI_RO> lineRoList) {
