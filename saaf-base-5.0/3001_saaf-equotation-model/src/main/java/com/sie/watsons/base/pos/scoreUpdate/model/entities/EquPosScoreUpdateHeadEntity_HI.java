package com.sie.watsons.base.pos.scoreUpdate.model.entities;
...
/**
 * EquPosScoreUpdateHeadEntity_HI Entity Object
 * Tue Sep 24 13:55:54 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_score_update_head")
public class EquPosScoreUpdateHeadEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "EQU_POS_SCORE_UPDATE_HEAD_S", sequenceName = "EQU_POS_SCORE_UPDATE_HEAD_S", allocationSize = 1)
	@GeneratedValue(generator = "EQU_POS_SCORE_UPDATE_HEAD_S", strategy = GenerationType.SEQUENCE)
