...
/**   EquPosZzscCategoryEntity_HI_RO.QUERY_SQL
 * EquPosZzscCategoryEntity_HI_RO Entity Object
 * Fri Sep 20 18:01:38 CST 2019  Auto Generate
 */

public class EquPosZzscCategoryEntity_HI_RO {
	public static void main(String[] args) {
		System.out.println(QUERY_WAREHOUSING_SQL);
	}
	//查询供应商品类
	//查询供应商品类
	public  static  final String  QUERY_WAREHOUSING_SQL ="SELECT src.supplier_category_id supplierCategoryId\n" +
			"      ,src.supplier_id          supplierId\n" +
			"      ,src.category_id          categoryId\n" +
			"      ,sc.category_group        categoryName \n" +
			"      ,src.status               status\n" +
			"      ,src.dept_code            deptCode\n" +
			"      ,src.qualification_id qualificationId\n" +
