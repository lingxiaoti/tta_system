...
/**
 * EquPosZzscOperationStatusEntity_HI_RO Entity Object
 * Fri Sep 20 18:01:33 CST 2019  Auto Generate
 */

public class EquPosZzscOperationStatusEntity_HI_RO {
	public  static  final String  QUERY_SQL =
			"SELECT os.operational_id operationalId\n" +
					...
					"      ,os.qualification_id qualificationId\n" +
					...
					"      ,os.attribute9\n" +
					"      ,os.attribute10\n" +
					"FROM   equ_pos_zzsc_operation_status os where 1 = 1";
