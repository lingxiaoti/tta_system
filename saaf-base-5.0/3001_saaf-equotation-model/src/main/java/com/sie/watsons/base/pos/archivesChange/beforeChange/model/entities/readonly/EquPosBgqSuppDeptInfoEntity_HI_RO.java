...
/**   EquPosBgqSuppDeptInfoEntity_HI_RO.QUERY_SQL
 * EquPosBgqSuppDeptInfoEntity_HI_RO Entity Object
 * Wed Sep 25 01:18:40 CST 2019  Auto Generate
 */

public class EquPosBgqSuppDeptInfoEntity_HI_RO {
	public  static  final String  QUERY_SQL =
			"SELECT s.id\n" +
					"      ,s.supplier_id        supplierId\n" +
					"      ,s.dept_code          deptCode\n" +
					"      ,s.supplier_type      supplierType\n" +
					"      ,s.change_id          changeId\n" +
					...
					"      ,s.attribute9\n" +
					"      ,s.attribute10\n" +
					"      ,lv1.meaning          supplierTypeMeaning\n" +
					"FROM   equ_pos_bgq_supp_dept_info s\n" +
					"WHERE  1 = 1";
