...
/**
 * EquPonProjectAttachmentEntity_HI Entity Object
 * Fri Oct 04 11:17:40 CST 2019  Auto Generate
 */
@Entity
@Table(name="EQU_PON_PROJECT_ATTACHMENT")
public class EquPonProjectAttachmentEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "EQU_PON_PROJECT_ATTACHMENT_S", sequenceName = "EQU_PON_PROJECT_ATTACHMENT_S", allocationSize = 1)
	@GeneratedValue(generator = "EQU_PON_PROJECT_ATTACHMENT_S", strategy = GenerationType.SEQUENCE)
