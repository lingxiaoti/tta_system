...
/**
 * EquPosBgqCredentialAttachEntity_HI Entity Object
 * Wed Sep 25 01:18:35 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_bgq_credential_attach")
public class EquPosBgqCredentialAttachEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "equ_pos_bgq_credent_attach_s", sequenceName = "equ_pos_bgq_credent_attach_s", allocationSize = 1)
	@GeneratedValue(generator = "equ_pos_bgq_credent_attach_s", strategy = GenerationType.SEQUENCE)
