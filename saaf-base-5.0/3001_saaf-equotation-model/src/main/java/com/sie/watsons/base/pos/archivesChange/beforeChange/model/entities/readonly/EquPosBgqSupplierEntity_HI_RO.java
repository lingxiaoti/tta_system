...
/**   EquPosBgqSupplierEntity_HI_RO.QUERY_SQL
 * EquPosBgqSupplierEntity_HI_RO Entity Object
 * Wed Sep 25 01:18:39 CST 2019  Auto Generate
 */

public class EquPosBgqSupplierEntity_HI_RO {
...
//					"      ,psi.supplier_file_path filePath\n" +
					...
					"      ,(SELECT COUNT(1)\n" +
					"        FROM   equ_pos_Bgq_credential_attach a\n" +
					...
					"FROM   equ_pos_Bgq_supplier       psi\n" +
					"      ,equ_pos_Bgq_supp_dept_info d\n" +
