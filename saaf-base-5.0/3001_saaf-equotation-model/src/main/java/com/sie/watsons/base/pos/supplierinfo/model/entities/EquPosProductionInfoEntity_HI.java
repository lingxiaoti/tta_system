...
/**
 * EquPosProductionInfoEntity_HI Entity Object
 * Thu Sep 05 18:12:55 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_production_info")
public class EquPosProductionInfoEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "EQU_POS_PRODUCTION_INFO_S", sequenceName = "EQU_POS_PRODUCTION_INFO_S", allocationSize = 1)
	@GeneratedValue(generator = "EQU_POS_PRODUCTION_INFO_S", strategy = GenerationType.SEQUENCE)
