...
/**
 * EquPonItScoringTeamEntity_HI Entity Object
 * Mon Dec 16 23:18:05 CST 2019  Auto Generate
 */
@Entity
@Table(name="EQU_PON_IT_SCORING_TEAM")
public class EquPonItScoringTeamEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "EQU_PON_IT_SCORING_TEAM_S", sequenceName = "EQU_PON_IT_SCORING_TEAM_S", allocationSize = 1)
	@GeneratedValue(generator = "EQU_PON_IT_SCORING_TEAM_S", strategy = GenerationType.SEQUENCE)
	...
	@Column(name="member_role", nullable=true, length=20)	
