...
/**
 * EquPosBgqSupplierEntity_HI Entity Object
 * Wed Sep 25 01:18:39 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_bgq_supplier")
public class EquPosBgqSupplierEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "equ_pos_bgq_supplier_s", sequenceName = "equ_pos_bgq_supplier_s", allocationSize = 1)
	@GeneratedValue(generator = "equ_pos_bgq_supplier_s", strategy = GenerationType.SEQUENCE)
