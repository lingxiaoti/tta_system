...
/**
 * EquPosBgCredentialAttachEntity_HI Entity Object
 * Tue Sep 24 14:10:16 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_bg_credential_attach")
public class EquPosBgCredentialAttachEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "equ_pos_bg_credential_attach_s", sequenceName = "equ_pos_bg_credential_attach_s", allocationSize = 1)
	@GeneratedValue(generator = "equ_pos_bg_credential_attach_s", strategy = GenerationType.SEQUENCE)
