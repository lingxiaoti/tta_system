...
/**
 * EquPosBgqProductionInfoEntity_HI Entity Object
 * Wed Sep 25 01:18:36 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_bgq_production_info")
public class EquPosBgqProductionInfoEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "equ_pos_bgq_production_info_s", sequenceName = "equ_pos_bgq_production_info_s", allocationSize = 1)
	@GeneratedValue(generator = "equ_pos_bgq_production_info_s", strategy = GenerationType.SEQUENCE)
