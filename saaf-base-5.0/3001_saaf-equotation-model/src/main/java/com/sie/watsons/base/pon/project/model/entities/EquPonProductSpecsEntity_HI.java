...
/**
 * EquPonProductSpecsEntity_HI Entity Object
 * Fri Oct 04 11:17:39 CST 2019  Auto Generate
 */
@Entity
@Table(name="EQU_PON_PRODUCT_SPECS")
public class EquPonProductSpecsEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "EQU_PON_PRODUCT_SPECS_S", sequenceName = "EQU_PON_PRODUCT_SPECS_S", allocationSize = 1)
	@GeneratedValue(generator = "EQU_PON_PRODUCT_SPECS_S", strategy = GenerationType.SEQUENCE)
	@Column(name="specs_id", nullable=false, length=22)	
	...
	@Column(name="target_cost", nullable=true, length=22)	
