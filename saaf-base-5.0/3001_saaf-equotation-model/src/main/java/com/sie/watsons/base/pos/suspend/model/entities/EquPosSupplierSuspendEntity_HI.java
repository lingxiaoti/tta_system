package com.sie.watsons.base.pos.suspend.model.entities;
...
/**
 * EquPosSupplierSuspendEntity_HI Entity Object
 * Thu Sep 05 17:41:22 CST 2019  Auto Generate
 */
@Entity
@Table(name = "EQU_POS_SUPPLIER_SUSPEND")
public class EquPosSupplierSuspendEntity_HI {
	...
	@Column(name = "sup_suspend_reason", nullable = true, length = 240)	
	...
	@Id
	@SequenceGenerator(name = "EQU_POS_SUPPLIER_SUSPEND_S", sequenceName = "EQU_POS_SUPPLIER_SUSPEND_S", allocationSize = 1)
	@GeneratedValue(generator = "EQU_POS_SUPPLIER_SUSPEND_S", strategy = GenerationType.SEQUENCE)
	@Column(name = "sup_suspend_id", nullable = false, length = 22)
	...
	@Column(name = "sup_suspend_code", nullable = false, length = 240)	
	...
	@Column(name = "sup_suspend_status", nullable = true, length = 240)	
	...
	@Column(name = "sup_suspend_type", nullable = true, length = 240)	
	...
	@Column(name = "sup_suspend_date", nullable = true, length = 7)	
