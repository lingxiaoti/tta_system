...
/**
 * EquPosCredentialsAttachmentEntity_HI Entity Object
 * Thu Sep 12 17:25:51 CST 2019  Auto Generate
 */
@Entity
@Table(name="EQU_POS_CREDENTIALS_ATTACHMENT")
public class EquPosCredentialsAttachmentEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "equ_pos_credentials_attach_s", sequenceName = "equ_pos_credentials_attach_s", allocationSize = 1)
	@GeneratedValue(generator = "equ_pos_credentials_attach_s", strategy = GenerationType.SEQUENCE)
