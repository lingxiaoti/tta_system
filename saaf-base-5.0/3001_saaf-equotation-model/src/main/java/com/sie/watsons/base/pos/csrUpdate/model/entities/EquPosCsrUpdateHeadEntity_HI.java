package com.sie.watsons.base.pos.csrUpdate.model.entities;
...
/**
 * EquPosCsrUpdateHeadEntity_HI Entity Object
 * Sat Sep 21 10:08:56 CST 2019  Auto Generate
 */
@Entity
@Table(name="EQU_POS_CSR_UPDATE_HEAD")
public class EquPosCsrUpdateHeadEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "EQU_POS_CSR_UPDATE_HEAD_SEQ", sequenceName = "EQU_POS_CSR_UPDATE_HEAD_SEQ", allocationSize = 1)
	@GeneratedValue(generator = "EQU_POS_CSR_UPDATE_HEAD_SEQ", strategy = GenerationType.SEQUENCE)
