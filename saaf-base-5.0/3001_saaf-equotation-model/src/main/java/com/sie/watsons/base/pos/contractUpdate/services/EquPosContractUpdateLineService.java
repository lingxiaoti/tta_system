...
@RestController
@RequestMapping("/equPosContractUpdateLineService")
public class EquPosContractUpdateLineService extends CommonAbstractService {
    private static final Logger LOGGER = LoggerFactory.getLogger(EquPosContractUpdateLineService.class);
    @Autowired
    private IEquPosContractUpdateLine equPosContractUpdateLineServer;

    @Override
    public IBaseCommon getBaseCommonServer() {
        return this.equPosContractUpdateLineServer;
    }
     ...
     * @return
     */
    @PostMapping("/saveImportForContractUpdate")
    public String saveImportForContractUpdate(@RequestParam(required = true) String params) {
        try {
            Integer userId = getSessionUserId();
            int size = equPosContractUpdateLineServer.saveImportForContractUpdate(params, userId);
    ...
    @PostMapping("/findContractUpdateLinePagination")
    public String findContractUpdateLinePagination(@RequestParam("params") String editParams,
        ...
        try {
            ...
            jsonObject = equPosContractUpdateLineServer.findContractUpdateLinePagination(jsonObject, pageIndex, pageRows);
    ...
    @PostMapping("/deleteContractUpdateLine")
    public String deleteContractUpdateLine(@RequestParam(required = true) String params) {
        try {
            ...
            return equPosContractUpdateLineServer.deleteContractUpdateLine(jsonObject, userId);
        } catch (IllegalArgumentException e) {
