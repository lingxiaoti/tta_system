...
/**
 * EquPosSuppInfoWithDeptEntity_HI Entity Object
 * Tue Oct 29 18:12:06 CST 2019  Auto Generate
 */
@Entity
@Table(name="EQU_POS_SUPP_INFO_WITH_DEPT")
public class EquPosSuppInfoWithDeptEntity_HI {
    private Integer id;
	...
	@Id
	@SequenceGenerator(name = "EQU_POS_SUPP_INFO_WITH_DEPT_S", sequenceName = "EQU_POS_SUPP_INFO_WITH_DEPT_S", allocationSize = 1)
	@GeneratedValue(generator = "EQU_POS_SUPP_INFO_WITH_DEPT_S", strategy = GenerationType.SEQUENCE)
