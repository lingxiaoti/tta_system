...
/**
 * EquPosBgqContactsEntity_HI Entity Object
 * Wed Sep 25 01:18:38 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_bgq_contacts")
public class EquPosBgqContactsEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "equ_pos_bgq_contacts_s", sequenceName = "equ_pos_bgq_contacts_s", allocationSize = 1)
	@GeneratedValue(generator = "equ_pos_bgq_contacts_s", strategy = GenerationType.SEQUENCE)
