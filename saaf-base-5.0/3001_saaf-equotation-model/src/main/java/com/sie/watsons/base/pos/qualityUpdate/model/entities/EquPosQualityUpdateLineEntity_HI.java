...
/**
 * EquPosQualityUpdateLindEntity_HI Entity Object
 * Wed Sep 18 11:40:32 CST 2019  Auto Generate
 */
@Entity
@Table(name="EQU_POS_QUALITY_UPDATE_LINE")
public class EquPosQualityUpdateLineEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "EQU_POS_QUALITY_UPDATE_LINE_S", sequenceName = "EQU_POS_QUALITY_UPDATE_LINE_S", allocationSize = 1)
	@GeneratedValue(generator = "EQU_POS_QUALITY_UPDATE_LINE_S", strategy = GenerationType.SEQUENCE)
	...
	@Column(name="category", nullable=true, length=240)	
