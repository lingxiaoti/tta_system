...
/**
 * EquPosZzscAssociateSuppEntity_HI Entity Object
 * Fri Sep 20 18:01:30 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_zzsc_associate_supp")
public class EquPosZzscAssociateSuppEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "equ_pos_zzsc_associate_supp_s", sequenceName = "equ_pos_zzsc_associate_supp_s", allocationSize = 1)
	@GeneratedValue(generator = "equ_pos_zzsc_associate_supp_s", strategy = GenerationType.SEQUENCE)
