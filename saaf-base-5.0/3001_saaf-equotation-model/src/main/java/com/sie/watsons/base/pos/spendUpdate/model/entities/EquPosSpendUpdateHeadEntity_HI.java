...
/**
 * EquPosSpendUpdateHeadEntity_HI Entity Object
 * Tue Sep 24 13:57:06 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_spend_update_head")
public class EquPosSpendUpdateHeadEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "EQU_POS_SPEND_UPDATE_HEAD_S", sequenceName = "EQU_POS_SPEND_UPDATE_HEAD_S", allocationSize = 1)
	@GeneratedValue(generator = "EQU_POS_SPEND_UPDATE_HEAD_S", strategy = GenerationType.SEQUENCE)
