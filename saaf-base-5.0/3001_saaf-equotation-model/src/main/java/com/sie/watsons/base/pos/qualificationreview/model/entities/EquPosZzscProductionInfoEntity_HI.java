...
/**
 * EquPosZzscProductionInfoEntity_HI Entity Object
 * Fri Sep 20 18:01:33 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_zzsc_production_info")
public class EquPosZzscProductionInfoEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "equ_pos_zzsc_production_info_s", sequenceName = "equ_pos_zzsc_production_info_s", allocationSize = 1)
	@GeneratedValue(generator = "equ_pos_zzsc_production_info_s", strategy = GenerationType.SEQUENCE)
	...
	@Column(name="factory_area", nullable=true, length=11)
	...
	@Column(name="production_area", nullable=true, length=11)
	...
	@Column(name="finished_product_area", nullable=true, length=11)
	...
	@Column(name="raw_material_area", nullable=true, length=11)
	...
	@Column(name="packaging_area", nullable=true, length=11)
	...
	@Column(name="laboratory_area", nullable=true, length=11)
	...
	@Column(name="office_area", nullable=true, length=11)
