...
/**
 * EquPosBgCredentialAttachEntity_HI_RO Entity Object
 * Tue Sep 24 14:10:16 CST 2019  Auto Generate
 */

public class EquPosBgCredentialAttachEntity_HI_RO {
	public static void main(String[] args) {
		System.out.println(QUERY_SQL_OPERATIONAL);
	}
	//查询供应商资质文件信息
	public  static  final String  QUERY_SQL =
			"SELECT t.attachment_id attachmentId\n" +
					...
					"FROM   equ_pos_bg_credential_attach t\n" +
