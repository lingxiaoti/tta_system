...
/**
 * EquPonProjectAttachmentEntity_HI_RO Entity Object
 * Fri Oct 04 11:17:40 CST 2019  Auto Generate
 */

public class EquPonProjectAttachmentEntity_HI_RO {
	//查询立项单据附件信息
	public  static  final String  QUERY_SQL =
			"SELECT t.attachment_id attachmentId\n" +
					...
					"      ,t.selected_flag selectedFlag2\n" +
					"      ,nvl(t.selected_flag,'N') selectedFlag\n" +
					...
					"      ,t.attribute9\n" +
					"      ,t.attribute10\n" +
					"FROM   equ_pon_project_attachment t\n" +
					"where 1 = 1";
	...
	public void setSelectedFlag2(String selectedFlag2) {
		this.selectedFlag2 = selectedFlag2;
	}
