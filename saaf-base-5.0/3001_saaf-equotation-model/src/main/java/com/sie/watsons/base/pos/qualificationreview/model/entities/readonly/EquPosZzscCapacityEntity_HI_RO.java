...
/**
 * EquPosZzscCapacityEntity_HI_RO Entity Object
 * Fri Sep 20 18:01:31 CST 2019  Auto Generate
 */

public class EquPosZzscCapacityEntity_HI_RO {
	...
	public  static  final String  QUERY_SQL =
			"SELECT pci.capacity_id capacityId\n" +
					...
					"      ,pci.qualification_id qualificationId\n" +
					...
					"FROM   equ_pos_zzsc_capacity pci\n" +
					"where 1 = 1";
