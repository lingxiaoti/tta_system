...
/**
 * EquPosZzscProductionInfoEntity_HI_RO Entity Object
 * Fri Sep 20 18:01:33 CST 2019  Auto Generate
 */

public class EquPosZzscProductionInfoEntity_HI_RO {
	//查询供应商生产信息
	public  static  final String  QUERY_SQL =
			"SELECT ppi.production_id productionId\n" +
					...
					"      ,ppi.qualification_id qualificationId\n" +
					...
					"      ,ppi.attribute9\n" +
					"      ,ppi.attribute10\n" +
					"FROM   equ_pos_zzsc_production_info ppi where 1 = 1 ";
