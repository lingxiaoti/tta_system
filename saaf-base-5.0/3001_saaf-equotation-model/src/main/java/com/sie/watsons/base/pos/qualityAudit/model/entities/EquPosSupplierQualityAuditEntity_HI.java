package com.sie.watsons.base.pos.qualityAudit.model.entities;
...
/**
 * EquPosSupplierQualityAuditEntity_HI Entity Object
 * Mon Sep 16 21:43:33 CST 2019  Auto Generate
 */
@Entity
@Table(name="EQU_POS_SUPPLIER_QUALITY_AUDIT")
public class EquPosSupplierQualityAuditEntity_HI {
    ...
    private Integer auditCapReportId;
    private String auditCapReportName;
    private String auditCapReportPath;
	@JSONField(format="yyyy-MM-dd HH:mm:ss")
	private Date qualityAuditDate;
	...
	@Id
	@SequenceGenerator(name = "EQU_POS_SUPP_QUALITY_AUDIT_S", sequenceName = "EQU_POS_SUPP_QUALITY_AUDIT_S", allocationSize = 1)
	@GeneratedValue(generator = "EQU_POS_SUPP_QUALITY_AUDIT_S", strategy = GenerationType.SEQUENCE)
	@Column(name="quality_audit_id", nullable=false, length=22)	
	...
	@Column(name="quality_audit_number", nullable=true, length=20)	
	...
	@Column(name="quality_audit_status", nullable=true, length=20)
	...
	@Column(name="quality_audit_score", nullable=true, length=22)	
	...
	@Column(name="quality_audit_result", nullable=true, length=20)	
	...
	@Column(name="quality_audit_date", nullable=true, length=7)
	...
	@Column(name="audit_cap_report_id", nullable=true, length=22)	
	...
	@Column(name="audit_cap_report_name", nullable=true, length=100)	
	...
	@Column(name="audit_cap_report_path", nullable=true, length=240)	
