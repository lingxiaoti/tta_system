...
/**
 * EquPosScoreUpdateLineEntity_HI Entity Object
 * Tue Sep 24 13:55:54 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_score_update_line")
public class EquPosScoreUpdateLineEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "EQU_POS_SCORE_UPDATE_LINE_S", sequenceName = "EQU_POS_SCORE_UPDATE_LINE_S", allocationSize = 1)
	@GeneratedValue(generator = "EQU_POS_SCORE_UPDATE_LINE_S", strategy = GenerationType.SEQUENCE)
