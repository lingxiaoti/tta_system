...
/**
 * EquPosBgOperationStatusEntity_HI_RO Entity Object
 * Tue Sep 24 14:10:17 CST 2019  Auto Generate
 */

public class EquPosBgOperationStatusEntity_HI_RO {
	public  static  final String  QUERY_SQL =
			"SELECT os.operational_id operationalId\n" +
					...
					"      ,os.change_id changeId\n" +
					"      ,os.source_id sourceId\n" +
					...
					"      ,os.attribute9\n" +
					"      ,os.attribute10\n" +
					"FROM   equ_pos_bg_operation_status os where 1 = 1";
