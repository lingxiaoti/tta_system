package com.sie.watsons.base.pos.scoreUpdate.model.entities.readonly;
...
/**
 * EquPosScoreUpdateHeadEntity_HI_RO Entity Object
 * Tue Sep 24 13:55:54 CST 2019  Auto Generate
 */

public class EquPosScoreUpdateHeadEntity_HI_RO {
    //	EquPosScoreUpdateHeadEntity_HI_RO.Query_HEAD_ONLY
    public static final String Query_HEAD_ONLY = "select t.UPDATE_HEAD_ID    updateHeadId,\n" +
            ...
            "       t.dept_id           deptId,\n" +
            "       t.remark            remark\n" +
            "  from equ_pos_score_update_head t\n" +
            " where 1 = 1";


    //	EquPosScoreUpdateHeadEntity_HI_RO.QUERY_HEAD_SQL
    ...
    public List<EquPosScoreUpdateLineEntity_HI_RO> getLineRoList() {
        return lineRoList;
    }

    public void setLineRoList(List<EquPosScoreUpdateLineEntity_HI_RO> lineRoList) {
