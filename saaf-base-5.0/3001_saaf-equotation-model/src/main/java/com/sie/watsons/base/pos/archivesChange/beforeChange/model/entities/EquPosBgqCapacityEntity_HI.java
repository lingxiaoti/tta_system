...
/**
 * EquPosBgqCapacityEntity_HI Entity Object
 * Wed Sep 25 01:18:34 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_bgq_capacity")
public class EquPosBgqCapacityEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "equ_pos_bgq_capacity_s", sequenceName = "equ_pos_bgq_capacity_s", allocationSize = 1)
	@GeneratedValue(generator = "equ_pos_bgq_capacity_s", strategy = GenerationType.SEQUENCE)
	...
	@Column(name="production_capacity_file_name", nullable=true, length=100)
