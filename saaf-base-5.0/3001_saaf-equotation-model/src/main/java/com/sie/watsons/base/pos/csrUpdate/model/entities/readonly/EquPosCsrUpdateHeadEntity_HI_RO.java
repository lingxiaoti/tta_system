package com.sie.watsons.base.pos.csrUpdate.model.entities.readonly;
...
/**
 * EquPosCsrUpdateHeadEntity_HI_RO Entity Object
 * Sat Sep 21 10:08:56 CST 2019  Auto Generate
 */

public class EquPosCsrUpdateHeadEntity_HI_RO {
    //    EquPosCsrUpdateHeadEntity_HI_RO.Query_HEAD_ONLY
    public static final String Query_HEAD_ONLY = "select t.UPDATE_HEAD_ID    updateHeadId,\n" +
            ...
            "       t.dept_id           deptId,\n" +
            "       t.remark            remark\n" +
            "  from equ_pos_Csr_update_head t\n" +
            " where 1 = 1";

    //    EquPosCsrUpdateHeadEntity_HI_RO.QUERY_HEAD_SQL
    ...
    public List<EquPosCsrUpdateLineEntity_HI_RO> getLineRoList() {
        return lineRoList;
    }

    public void setLineRoList(List<EquPosCsrUpdateLineEntity_HI_RO> lineRoList) {
