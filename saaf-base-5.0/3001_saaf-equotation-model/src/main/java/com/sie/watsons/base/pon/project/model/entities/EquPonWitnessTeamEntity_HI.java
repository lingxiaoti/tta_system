...
/**
 * EquPonWitnessTeamEntity_HI Entity Object
 * Fri Oct 04 11:17:42 CST 2019  Auto Generate
 */
@Entity
@Table(name="EQU_PON_WITNESS_TEAM")
public class EquPonWitnessTeamEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "EQU_PON_WITNESS_TEAM_S", sequenceName = "EQU_PON_WITNESS_TEAM_S", allocationSize = 1)
	@GeneratedValue(generator = "EQU_PON_WITNESS_TEAM_S", strategy = GenerationType.SEQUENCE)
