...
/**
 * EquPosBgCategoryEntity_HI Entity Object
 * Tue Sep 24 14:10:22 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_bg_category")
public class EquPosBgCategoryEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "equ_pos_bg_category_s", sequenceName = "equ_pos_bg_category_s", allocationSize = 1)
	@GeneratedValue(generator = "equ_pos_bg_category_s", strategy = GenerationType.SEQUENCE)
