...
/**
 * EquPosBgCredentialsEntity_HI Entity Object
 * Sun Nov 10 18:59:32 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_bg_credentials")
public class EquPosBgCredentialsEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "equ_pos_bg_credentials_s", sequenceName = "equ_pos_bg_credentials_s", allocationSize = 1)
	@GeneratedValue(generator = "equ_pos_bg_credentials_s", strategy = GenerationType.SEQUENCE)
