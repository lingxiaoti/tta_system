...
/**
 * EquPosBgSuppDeptInfoEntity_HI Entity Object
 * Tue Sep 24 14:10:23 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_bg_supp_dept_info")
public class EquPosBgSuppDeptInfoEntity_HI {
    private Integer id;
	...
	@Id
	@SequenceGenerator(name = "equ_pos_bg_supp_dept_info_s", sequenceName = "equ_pos_bg_supp_dept_info_s", allocationSize = 1)
	@GeneratedValue(generator = "equ_pos_bg_supp_dept_info_s", strategy = GenerationType.SEQUENCE)
