...
/**
 * EquPosZzscCredentialsEntity_HI_RO Entity Object
 * Fri Sep 20 18:01:36 CST 2019  Auto Generate
 */

public class EquPosZzscCredentialsEntity_HI_RO {
	//查询供应商资质信息
	public  static  final String  QUERY_SQL =
			...
			"SELECT sc.credentials_id credentialsId\n" +
					...
					"      ,sc.qualification_id qualificationId\n" +
					...
					"FROM   equ_pos_zzsc_credentials sc\n" +
					"where 1 = 1";
