...
/**
 * EquPosBgqCredentialsEntity_HI Entity Object
 * Sun Nov 10 19:04:42 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_bgq_credentials")
public class EquPosBgqCredentialsEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "equ_pos_bgq_credentials_s", sequenceName = "equ_pos_bgq_credentials_s", allocationSize = 1)
	@GeneratedValue(generator = "equ_pos_bgq_credentials_s", strategy = GenerationType.SEQUENCE)
	...
	@Column(name="credentials_id", nullable=true, length=22)	
