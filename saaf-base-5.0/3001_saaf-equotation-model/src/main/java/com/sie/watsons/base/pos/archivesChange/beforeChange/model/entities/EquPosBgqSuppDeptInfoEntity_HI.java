...
/**
 * EquPosBgqSuppDeptInfoEntity_HI Entity Object
 * Wed Sep 25 01:18:40 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_bgq_supp_dept_info")
public class EquPosBgqSuppDeptInfoEntity_HI {
    private Integer id;
	...
	@Id
	@SequenceGenerator(name = "equ_pos_bgq_supp_dept_info_s", sequenceName = "equ_pos_bgq_supp_dept_info_s", allocationSize = 1)
	@GeneratedValue(generator = "equ_pos_bgq_supp_dept_info_s", strategy = GenerationType.SEQUENCE)
