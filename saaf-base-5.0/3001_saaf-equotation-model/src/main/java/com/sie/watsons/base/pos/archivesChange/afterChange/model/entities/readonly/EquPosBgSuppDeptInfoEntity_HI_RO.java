...
/**   EquPosBgSuppDeptInfoEntity_HI_RO.QUERY_SQL
 * EquPosBgSuppDeptInfoEntity_HI_RO Entity Object
 * Tue Sep 24 14:10:23 CST 2019  Auto Generate
 */

public class EquPosBgSuppDeptInfoEntity_HI_RO {
	public  static  final String  QUERY_SQL =
			"SELECT s.id\n" +
					...
					"      ,s.attribute9\n" +
					"      ,s.attribute10\n" +
					"FROM   equ_pos_bg_supp_dept_info s\n" +
					"where  1 = 1";
