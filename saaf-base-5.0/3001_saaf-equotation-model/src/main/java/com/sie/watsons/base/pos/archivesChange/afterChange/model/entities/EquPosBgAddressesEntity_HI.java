...
/**
 * EquPosBgAddressesEntity_HI Entity Object
 * Tue Sep 24 14:10:19 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_bg_addresses")
public class EquPosBgAddressesEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "equ_pos_bg_addresses_s", sequenceName = "equ_pos_bg_addresses_s", allocationSize = 1)
	@GeneratedValue(generator = "equ_pos_bg_addresses_s", strategy = GenerationType.SEQUENCE)
