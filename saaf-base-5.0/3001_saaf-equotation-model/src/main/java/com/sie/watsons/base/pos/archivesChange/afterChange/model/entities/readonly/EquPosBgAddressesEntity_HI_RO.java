...
/**
 * EquPosBgAddressesEntity_HI_RO Entity Object
 * Tue Sep 24 14:10:19 CST 2019  Auto Generate
 */

public class EquPosBgAddressesEntity_HI_RO {
	//供应商地址信息查询
	public  static  final String  QUERY_SQL =
			"SELECT sa.supplier_address_id supplierAddressId\n" +
					...
					"      ,sa.attribute9\n" +
					"      ,sa.attribute10\n" +
					"FROM   equ_pos_Bg_addresses sa where 1 = 1 ";
	...
	private EquPosBgOperationStatusEntity_HI_RO itOperationalInfoParams;
	private List<EquPosBgCapacityEntity_HI_RO> itCapacityInfoParams;
	private List<EquPosBgqCapacityEntity_HI_RO> itCapacityInfoBgqParams;
	private EquPosBgqOperationStatusEntity_HI_RO itOperationalInfoBgqParams;

	private List<EquPosBgCredentialAttachEntity_HI_RO> surEnvironmentDataTable;
	private List<EquPosBgCredentialAttachEntity_HI_RO> doorPlateDataTable;
	private List<EquPosBgCredentialAttachEntity_HI_RO> receptionDataTable;
	private List<EquPosBgCredentialAttachEntity_HI_RO> companyAreaDataTable;
	private List<EquPosBgCredentialAttachEntity_HI_RO> officeSpaceDataTable;
	private List<EquPosBgCredentialAttachEntity_HI_RO> employeeProfileDataTable;
	...
	public EquPosBgOperationStatusEntity_HI_RO getItOperationalInfoParams() {
		return itOperationalInfoParams;
	}

	public void setItOperationalInfoParams(EquPosBgOperationStatusEntity_HI_RO itOperationalInfoParams) {
		this.itOperationalInfoParams = itOperationalInfoParams;
	}

	public List<EquPosBgCapacityEntity_HI_RO> getItCapacityInfoParams() {
		return itCapacityInfoParams;
	}

	public void setItCapacityInfoParams(List<EquPosBgCapacityEntity_HI_RO> itCapacityInfoParams) {
		this.itCapacityInfoParams = itCapacityInfoParams;
	}

	public List<EquPosBgCredentialAttachEntity_HI_RO> getSurEnvironmentDataTable() {
		return surEnvironmentDataTable;
	}

	public void setSurEnvironmentDataTable(List<EquPosBgCredentialAttachEntity_HI_RO> surEnvironmentDataTable) {
		this.surEnvironmentDataTable = surEnvironmentDataTable;
	}

	public List<EquPosBgCredentialAttachEntity_HI_RO> getDoorPlateDataTable() {
		return doorPlateDataTable;
	}

	public void setDoorPlateDataTable(List<EquPosBgCredentialAttachEntity_HI_RO> doorPlateDataTable) {
		this.doorPlateDataTable = doorPlateDataTable;
	}

	public List<EquPosBgCredentialAttachEntity_HI_RO> getReceptionDataTable() {
		return receptionDataTable;
	}

	public void setReceptionDataTable(List<EquPosBgCredentialAttachEntity_HI_RO> receptionDataTable) {
		this.receptionDataTable = receptionDataTable;
	}

	public List<EquPosBgCredentialAttachEntity_HI_RO> getCompanyAreaDataTable() {
		return companyAreaDataTable;
	}

	public void setCompanyAreaDataTable(List<EquPosBgCredentialAttachEntity_HI_RO> companyAreaDataTable) {
		this.companyAreaDataTable = companyAreaDataTable;
	}

	public List<EquPosBgCredentialAttachEntity_HI_RO> getOfficeSpaceDataTable() {
		return officeSpaceDataTable;
	}

	public void setOfficeSpaceDataTable(List<EquPosBgCredentialAttachEntity_HI_RO> officeSpaceDataTable) {
		this.officeSpaceDataTable = officeSpaceDataTable;
	}

	public List<EquPosBgCredentialAttachEntity_HI_RO> getEmployeeProfileDataTable() {
		return employeeProfileDataTable;
	}

	public void setEmployeeProfileDataTable(List<EquPosBgCredentialAttachEntity_HI_RO> employeeProfileDataTable) {
	...
	public List<EquPosBgqCapacityEntity_HI_RO> getItCapacityInfoBgqParams() {
		return itCapacityInfoBgqParams;
	}

	public void setItCapacityInfoBgqParams(List<EquPosBgqCapacityEntity_HI_RO> itCapacityInfoBgqParams) {
		this.itCapacityInfoBgqParams = itCapacityInfoBgqParams;
	}

	public EquPosBgqOperationStatusEntity_HI_RO getItOperationalInfoBgqParams() {
		return itOperationalInfoBgqParams;
	}

	public void setItOperationalInfoBgqParams(EquPosBgqOperationStatusEntity_HI_RO itOperationalInfoBgqParams) {
		this.itOperationalInfoBgqParams = itOperationalInfoBgqParams;
	}
}
