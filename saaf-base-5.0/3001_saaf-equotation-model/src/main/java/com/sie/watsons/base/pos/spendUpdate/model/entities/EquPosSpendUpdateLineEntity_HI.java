package com.sie.watsons.base.pos.spendUpdate.model.entities;
...
/**
 * EquPosSpendUpdateLineEntity_HI Entity Object
 * Tue Sep 24 13:57:06 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_spend_update_line")
public class EquPosSpendUpdateLineEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "EQU_POS_SPEND_UPDATE_LINE_S", sequenceName = "EQU_POS_SPEND_UPDATE_LINE_S", allocationSize = 1)
	@GeneratedValue(generator = "EQU_POS_SPEND_UPDATE_LINE_S", strategy = GenerationType.SEQUENCE)
