...
/**
 * EquPosOperationalStatusEntity_HI Entity Object
 * Sat Sep 14 14:50:37 CST 2019  Auto Generate
 */
@Entity
@Table(name="EQU_POS_OPERATIONAL_STATUS")
public class EquPosOperationalStatusEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "EQU_POS_OPERATIONAL_STATUS_S", sequenceName = "EQU_POS_OPERATIONAL_STATUS_S", allocationSize = 1)
	@GeneratedValue(generator = "EQU_POS_OPERATIONAL_STATUS_S", strategy = GenerationType.SEQUENCE)
