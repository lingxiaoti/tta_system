...
/**    EquPosZzscSupplierEntity_HI_RO.QUERY_SQL
 * EquPosZzscSupplierEntity_HI_RO Entity Object
 * Fri Sep 20 18:01:37 CST 2019  Auto Generate
 */

public class EquPosZzscSupplierEntity_HI_RO {
	public static void main(String[] args) {
		System.out.println(QUERY_WAREHOUSING_SQL);
	}
	//查询供应商基础信息
	public  static  final String  QUERY_SQL =
			"SELECT psi.id\n" +
					...
					"      ,psi.qualification_id qualificationId\n" +
					...
					"      ,(SELECT COUNT(1)\n" +
					"        FROM   equ_pos_zzsc_credential_attach a\n" +
					...
					"FROM   equ_pos_zzsc_supplier       psi\n" +
					"      ,equ_pos_zzsc_supp_dept_info d\n" +
					"WHERE  psi.supplier_id = d.supplier_id(+) AND psi.qualification_id = d.qualification_id(+)";

	public  static  final String  QUERY_WAREHOUSING_SQL =
			"SELECT psi.id\n" +
					"      ,psi.supplier_id supplierId\n" +
					"      ,psi.file_name fileName\n" +
					"      ,psi.file_path filePath\n" +
					"      ,psi.supplier_number supplierNumber\n" +
					"      ,psi.supplier_name supplierName\n" +
					"      ,psi.supplier_short_name supplierShortName\n" +
					"      ,psi.home_url homeUrl\n" +
