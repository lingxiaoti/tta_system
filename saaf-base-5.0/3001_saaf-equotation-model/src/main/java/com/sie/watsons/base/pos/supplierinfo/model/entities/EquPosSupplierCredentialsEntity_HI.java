...
/**
 * EquPosSupplierCredentialsEntity_HI Entity Object
 * Sun Nov 10 18:43:37 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_supplier_credentials")
public class EquPosSupplierCredentialsEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "equ_pos_supplier_credentials_s", sequenceName = "equ_pos_supplier_credentials_s", allocationSize = 1)
	@GeneratedValue(generator = "equ_pos_supplier_credentials_s", strategy = GenerationType.SEQUENCE)
