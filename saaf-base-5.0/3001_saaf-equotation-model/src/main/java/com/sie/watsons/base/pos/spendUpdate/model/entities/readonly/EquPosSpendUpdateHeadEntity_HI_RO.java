package com.sie.watsons.base.pos.spendUpdate.model.entities.readonly;
...
/**
 * EquPosSpendUpdateHeadEntity_HI_RO.Query_HEAD_ONLY
 * EquPosSpendUpdateHeadEntity_HI_RO Entity Object
 * Tue Sep 24 13:57:06 CST 2019  Auto Generate
 */

public class EquPosSpendUpdateHeadEntity_HI_RO {
    ...
    public static final String Query_HEAD_ONLY = "select t.UPDATE_HEAD_ID    updateHeadId,\n" +
            ...
            "       t.dept_id           deptId,\n" +
            "       t.remark            remark\n" +
            "  from equ_pos_spend_update_head t\n" +
            " where 1 = 1";
    ...
    public List<EquPosSpendUpdateLineEntity_HI_RO> getLineRoList() {
        return lineRoList;
    }

    public void setLineRoList(List<EquPosSpendUpdateLineEntity_HI_RO> lineRoList) {
