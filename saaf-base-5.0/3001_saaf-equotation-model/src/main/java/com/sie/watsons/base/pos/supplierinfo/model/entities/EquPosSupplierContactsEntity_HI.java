...
/**
 * EquPosSupplierContactsEntity_HI Entity Object
 * Thu Sep 05 14:15:15 CST 2019  Auto Generate
 */
@Entity
@Table(name="EQU_POS_SUPPLIER_CONTACTS")
public class EquPosSupplierContactsEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "EQU_POS_SUPPLIER_CONTACTS_S", sequenceName = "EQU_POS_SUPPLIER_CONTACTS_S", allocationSize = 1)
	@GeneratedValue(generator = "EQU_POS_SUPPLIER_CONTACTS_S", strategy = GenerationType.SEQUENCE)
