...
/**
 * EquPosZzscAddressesEntity_HI Entity Object
 * Fri Sep 20 18:01:34 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_zzsc_addresses")
public class EquPosZzscAddressesEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "equ_pos_zzsc_addresses_s", sequenceName = "equ_pos_zzsc_addresses_s", allocationSize = 1)
	@GeneratedValue(generator = "equ_pos_zzsc_addresses_s", strategy = GenerationType.SEQUENCE)
