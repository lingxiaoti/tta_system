...
/**
 * EquPosSupplierCredentialsEntity_HI_RO Entity Object
 * Thu Sep 05 16:07:16 CST 2019  Auto Generate
 */

public class EquPosSupplierCredentialsEntity_HI_RO {
	...
	public  static  final String  QUERY_SQL =
			...
			"SELECT sc.credentials_id credentialsId\n" +
					...
					"FROM   equ_pos_supplier_credentials sc\n" +
					"where 1 = 1";
