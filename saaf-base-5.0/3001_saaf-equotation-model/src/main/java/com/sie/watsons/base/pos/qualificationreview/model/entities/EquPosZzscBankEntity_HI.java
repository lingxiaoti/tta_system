...
/**
 * EquPosZzscBankEntity_HI Entity Object
 * Fri Sep 20 18:01:35 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_zzsc_bank")
public class EquPosZzscBankEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "equ_pos_zzsc_bank_s", sequenceName = "equ_pos_zzsc_bank_s", allocationSize = 1)
	@GeneratedValue(generator = "equ_pos_zzsc_bank_s", strategy = GenerationType.SEQUENCE)
