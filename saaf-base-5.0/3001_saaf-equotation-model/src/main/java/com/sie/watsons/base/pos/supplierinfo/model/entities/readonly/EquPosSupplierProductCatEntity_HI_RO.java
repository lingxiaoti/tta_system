...
/**
 * EquPosSupplierProductCatEntity_HI_RO Entity Object
 * Thu Sep 05 15:10:18 CST 2019  Auto Generate
 */

public class EquPosSupplierProductCatEntity_HI_RO {
	public static void main(String[] args) {
		System.out.println(QUERY_SQL);
	}
	//查询供应商品类 EquPosSupplierProductCatEntity_HI_RO.QUERY_SQL
	public  static  final String  QUERY_SQL =
			"SELECT src.supplier_category_id supplierCategoryId\n" +
					...
					"FROM   equ_pos_supplier_product_cat src\n" +
					",equ_pos_supplier_category sc\n" +
					"where 1 = 1\n" +
					"AND    src.category_id = sc.category_maintain_id(+) ";
