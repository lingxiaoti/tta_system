...
/**
 * EquPosBgCapacityEntity_HI Entity Object
 * Tue Sep 24 14:10:15 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_bg_capacity")
public class EquPosBgCapacityEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "equ_pos_bg_capacity_s", sequenceName = "equ_pos_bg_capacity_s", allocationSize = 1)
	@GeneratedValue(generator = "equ_pos_bg_capacity_s", strategy = GenerationType.SEQUENCE)
