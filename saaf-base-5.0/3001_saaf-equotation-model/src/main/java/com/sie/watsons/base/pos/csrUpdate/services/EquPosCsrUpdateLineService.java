...
@RestController
@RequestMapping("/equPosCsrUpdateLineService")
public class EquPosCsrUpdateLineService extends CommonAbstractService {
    private static final Logger LOGGER = LoggerFactory.getLogger(EquPosCsrUpdateLineService.class);
    @Autowired
    private IEquPosCsrUpdateLine equPosCsrUpdateLineServer;

    @Override
    public IBaseCommon getBaseCommonServer() {
        return this.equPosCsrUpdateLineServer;
    }
     ...
     * @return
     */
    @PostMapping("/saveImportForCsrUpdate")
    public String saveImportForCsrUpdate(@RequestParam(required = true) String params) {
        try {
            int size = equPosCsrUpdateLineServer.saveImportForCsrUpdate(params, getSessionUserId());
    ...
    @PostMapping("/findCsrUpdateLinePagination")
    public String findCsrUpdateLinePagination(@RequestParam("params") String editParams,
...
//            jsonObject = equPosCsrUpdateLineServer.findCsrUpdateLinePagination(jsonObject.getInteger("updateHeadId"), pageIndex, pageRows);
            jsonObject = equPosCsrUpdateLineServer.findCsrUpdateLinePagination(jsonObject, pageIndex, pageRows);
    ...
    @PostMapping("/deleteCsrUpdateLine")
    public String deleteCsrUpdateLine(@RequestParam(required = true) String params) {
        try {
            ...
            return equPosCsrUpdateLineServer.deleteCsrUpdateLine(jsonObject, userId);
        } catch (IllegalArgumentException e) {
