...
/**
 * EquPosBgOperationStatusEntity_HI Entity Object
 * Tue Sep 24 14:10:17 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_bg_operation_status")
public class EquPosBgOperationStatusEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "equ_pos_bg_operation_status_s", sequenceName = "equ_pos_bg_operation_status_s", allocationSize = 1)
	@GeneratedValue(generator = "equ_pos_bg_operation_status_s", strategy = GenerationType.SEQUENCE)
