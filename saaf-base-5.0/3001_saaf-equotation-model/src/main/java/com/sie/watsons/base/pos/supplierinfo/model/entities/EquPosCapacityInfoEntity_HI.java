...
/**
 * EquPosCapacityInfoEntity_HI Entity Object
 * Thu Sep 05 18:12:52 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_capacity_info")
public class EquPosCapacityInfoEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "EQU_POS_CAPACITY_INFO_S", sequenceName = "EQU_POS_CAPACITY_INFO_S", allocationSize = 1)
	@GeneratedValue(generator = "EQU_POS_CAPACITY_INFO_S", strategy = GenerationType.SEQUENCE)
