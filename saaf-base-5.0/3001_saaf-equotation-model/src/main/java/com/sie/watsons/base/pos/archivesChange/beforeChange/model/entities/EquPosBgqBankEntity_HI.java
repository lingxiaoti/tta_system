...
/**
 * EquPosBgqBankEntity_HI Entity Object
 * Wed Sep 25 01:18:37 CST 2019  Auto Generate
 */
@Entity
@Table(name="equ_pos_bgq_bank")
public class EquPosBgqBankEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "equ_pos_bgq_bank_s", sequenceName = "equ_pos_bgq_bank_s", allocationSize = 1)
	@GeneratedValue(generator = "equ_pos_bgq_bank_s", strategy = GenerationType.SEQUENCE)
