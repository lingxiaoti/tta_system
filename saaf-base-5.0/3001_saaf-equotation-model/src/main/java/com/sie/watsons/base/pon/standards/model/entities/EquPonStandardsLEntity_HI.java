...
/**
 * EquPonStandardsLEntity_HI Entity Object
 * Tue Oct 08 09:39:43 CST 2019  Auto Generate
 */
@Entity
@Table(name="EQU_PON_standards_L")
public class EquPonStandardsLEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "EQU_PON_standards_L_S", sequenceName = "EQU_PON_standards_L_S", allocationSize = 1)
	@GeneratedValue(generator = "EQU_PON_standards_L_S", strategy = GenerationType.SEQUENCE)
	@Column(name="standards_l_id", nullable=false, length=22)
	...
	@Column(name="grading_division", nullable=true, length=240)
	...
	@Column(name="lineLv", nullable=true, length=22)
