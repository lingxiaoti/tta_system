package com.sie.watsons.base.pos.blacklist.model.entities;
...
/**
 * EquPosSupplierBlacklistEntity_HI Entity Object
 * Thu Sep 05 17:41:22 CST 2019  Auto Generate
 */
@Entity
@Table(name = "EQU_POS_SUPPLIER_blacklist")
public class EquPosSupplierBlacklistEntity_HI {
	...
	@Column(name = "sup_blacklist_reason", nullable = true, length = 240)
	...
	@Id
	@SequenceGenerator(name = "EQU_POS_SUPPLIER_blacklist_S", sequenceName = "EQU_POS_SUPPLIER_blacklist_S", allocationSize = 1)
	@GeneratedValue(generator = "EQU_POS_SUPPLIER_blacklist_S", strategy = GenerationType.SEQUENCE)
	@Column(name = "sup_blacklist_id", nullable = false, length = 22)
	...
	@Column(name = "sup_blacklist_code", nullable = false, length = 240)
	...
	@Column(name = "sup_blacklist_status", nullable = true, length = 240)
	...
	@Column(name = "sup_blacklist_type", nullable = true, length = 240)
	...
	@Column(name = "sup_blacklist_date", nullable = true, length = 7)
	public Date getSupBlacklistDate() {
		return supBlacklistDate;
	}

	@Column(name = "relate_dept_user_id", nullable = true, length = 22)
	...
	@Column(name = "relate_dept_user_number", nullable = true, length = 20)
