 ...
 */
@Component("access20DealerSubMQConsumerListener")
public class Access20DealerSubMQConsumerListener implements MessageListener {
    private static final Logger LOGGER = LoggerFactory.getLogger(Access20DealerSubMQConsumerListener.class);

    @Autowired
    public IBaseAccessBasedata baseAccessBasedataServer;

    @Override
    @JmsListener(containerFactory="jmsListenerContainerFactory",destination = "access20DealerSub20Queue",concurrency = "5-10")
    public void onMessage(Message message) {
        ...
        try {
            ...
            LOGGER.info("=========经销商子库20权限同步，MQ消费者执行完成=========");
