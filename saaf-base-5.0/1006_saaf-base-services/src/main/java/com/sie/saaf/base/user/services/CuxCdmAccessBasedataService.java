...
@RestController
@RequestMapping("/cuxCdmAccessBasedataService")
public class CuxCdmAccessBasedataService extends CommonAbstractService {
private static final Logger LOGGER = LoggerFactory.getLogger(CuxCdmAccessBasedataService.class);

	@Autowired
	private ICuxCdmAccessBasedata cuxCdmAccessBasedataServer;

	@Override
	public IBaseCommon getBaseCommonServer() {
		return cuxCdmAccessBasedataServer;
	}
