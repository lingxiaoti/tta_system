...
/**
 * @author ZhangJun
 * @createTime 2018-01-11 19:11
 * @description
 */
@RestController
@RequestMapping("/baseChannelService")
public class BaseChannelService extends CommonAbstractService {
	private static final Logger logger = LoggerFactory.getLogger(BaseChannelService.class);

	@Autowired
	private IBaseChannel baseChannelServer;

	@Override
	public IBaseCommon getBaseCommonServer() {
		return baseChannelServer;
	}
