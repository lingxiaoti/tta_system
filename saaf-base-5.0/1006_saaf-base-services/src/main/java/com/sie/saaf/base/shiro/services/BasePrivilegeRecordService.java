 ...
 */
@RestController
@RequestMapping("/basePrivilegeRecordService")
public class BasePrivilegeRecordService extends CommonAbstractService {
	private static final Logger logger = LoggerFactory.getLogger(BasePrivilegeRecordService.class);
	@Autowired
	private IBasePrivilegeRecord basePrivilegeRecordServer;

	@Override
	public IBaseCommon getBaseCommonServer() {
		return basePrivilegeRecordServer;
	}
