 ...
 */
@RestController
@RequestMapping("/baseProfileValueService")
public class BaseProfileValueService extends CommonAbstractService {

	private static final Logger logger = LoggerFactory.getLogger(BaseProfileValueService.class);
	...
	@GetMapping("getUserIds/{profileCodes}")
	public String getUserIds(@PathVariable("profileCodes") String profileCodes)
	{
		return baseProfileValueServer.getUserIds(profileCodes,"base_users");
	}
