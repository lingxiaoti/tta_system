...
@RestController
@RequestMapping("/perAllAssignmentsFService")
public class PerAllAssignmentsFService extends CommonAbstractService {
private static final Logger LOGGER = LoggerFactory.getLogger(PerAllAssignmentsFService.class);
	@Autowired
	private IPerAllAssignmentsF perAllAssignmentsFServer;
	public PerAllAssignmentsFService() {
		super();
	}

	@Override
	public IBaseCommon getBaseCommonServer() {
		return perAllAssignmentsFServer;
	}
