 ...
 */
@Component("access20DealerUserMQConsumerListener")
public class Access20DealerUserMQConsumerListener implements MessageListener {
    private static final Logger LOGGER = LoggerFactory.getLogger(Access20DealerUserMQConsumerListener.class);

    @Autowired
    public IBaseAccessBasedata baseAccessBasedataServer;

    @Override
    @JmsListener(containerFactory="jmsListenerContainerFactory",destination = "access20DealerUserQueue",concurrency = "5-10")
    public void onMessage(Message message) {
        ...
        try {
            ...
            LOGGER.info("=========经销商用户20权限同步，MQ消费者执行完成=========");
