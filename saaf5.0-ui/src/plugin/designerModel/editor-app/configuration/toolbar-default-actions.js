    ...
    ACTIONS: {
        ...
        saveModel: function (services) {
            ...
            $scope.save = function (successCallback) {
                ...
                // for(var ii = 0;ii < $scope.selectedItem.properties.length;ii++) {
                //     if($scope.selectedItem.properties[ii].key === 'oryx-name') {
                //         $scope.saveDialog.name = $scope.selectedItem.properties[ii].value
                //     }
                // }
