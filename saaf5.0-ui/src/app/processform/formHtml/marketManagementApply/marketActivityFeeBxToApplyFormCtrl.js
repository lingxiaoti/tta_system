...
define(['app','moment','angularFileUpload','../../../ems/service/http','webconfig'], function (app,moment,angularFileUpload,http,webconfig) {
    ...
    app.controller('marketActivityFeeBxToApplyFormCtrl', function ($scope, $location, $rootScope, $state, $stateParams, SIEJS,httpServer,URLAPI,pageResp,limitNumLength,$timeout) {
        $scope.params = {};
        $scope.storeParams = {};
        ...
        $scope.getCostUser = function(key,value,item){
            ...
            httpServer.post(URLAPI.findOaMarketingCostCompainDetailById, {
                ...
                if(res.status === 'S') {
                    ...
                    if($scope.formParams.costUserName){
                        $scope.formParams.costMain = 'Y';
                    }else {
                        $scope.formParams.costMain = 'N';
                    }
                    $scope.formParams.productLineData[0] = {};
                    $scope.formParams.accountLineData[0] = {};
                    $scope.init();
        ...
        $scope.passEvent.cusValidator = function(){
            httpServer.post(URLAPI.bx_updateOaMarketingCostCompainReByApproval, {
