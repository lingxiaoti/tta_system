...
define(['app','moment','angularFileUpload','../../../ems/service/http','webconfig'], function (app,moment,angularFileUpload,http,webconfig) {
    ...
    app.controller('promotionSalBxTooApplyFormCtrl', function ($scope, $location, $rootScope, $state, $stateParams, SIEJS,httpServer,URLAPI,pageResp,limitNumLength,$timeout,iframeTabAction,processGetStartUrl) {
        $scope.params = {};
        $scope.storeParams = {};
        ...
        $scope.getCostUser = function(key,value,item){
            ...
            httpServer.post(URLAPI.findOaMarketingCostSalesDetailById, {
        ...
        $scope.passEvent.cusValidator = function(){
            httpServer.post(URLAPI.bx_updateOaMarketingCostSalesReByApproval, {
        ...
        $scope.detailTwo = function() {
            $scope.gotoProcessForm($scope.formParams,$scope.formParams.bcRemiburseId,'查看报销（需申请:'+$scope.formParams.bcRemiburseId+'）','detail','Y');
        }
        /*
         * 费用申请编号查看
         *
