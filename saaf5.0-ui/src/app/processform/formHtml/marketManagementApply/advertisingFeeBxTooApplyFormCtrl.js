...
define(['app','moment','angularFileUpload','../../../ems/service/http','webconfig'], function (app,moment,angularFileUpload,http,webconfig) {
    ...
    app.controller('advertisingFeeBxTooApplyFormCtrl', function ($scope, $location, $rootScope, $state, $stateParams, SIEJS,httpServer,URLAPI,pageResp,limitNumLength,$timeout) {
        $scope.params = {};
        $scope.storeParams = {};
        ...
        $scope.getCostUser = function(key,value,item){
            ...
            httpServer.post(URLAPI.findOaMarketingCostAdDetailById, {
