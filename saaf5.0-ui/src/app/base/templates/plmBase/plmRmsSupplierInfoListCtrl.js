...
define(['app', 'pinyin', 'ztree'], function (app, pinyin, ztree) {
    app.controller('plmRmsSupplierInfoListCtrl', function ($scope, $filter, $location, $rootScope, $state, $stateParams, SIEJS, httpServer, URLAPI, iframeTabAction, setNewRow) {
