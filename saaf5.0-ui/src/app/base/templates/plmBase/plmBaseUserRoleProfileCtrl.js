...
define(['app', 'pinyin', 'ztree'], function (app, pinyin, ztree) {
    app.controller('plmBaseUserRoleProfileCtrl', function ($scope, $filter, $location, $rootScope, $state, $stateParams, SIEJS, httpServer, URLAPI, iframeTabAction, setNewRow) {
        ...
        {
            if($scope.addparams.serialName=='')
            {
                SIEJS.alert("系列名称不能为空!", "error", "确定");
                return;
            }
