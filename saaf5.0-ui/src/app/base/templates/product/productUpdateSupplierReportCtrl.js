...
define(["app"], function (app) {
    app.controller('productUpdateSupplierReportCtrl', ['$scope', 'URLAPI', '$rootScope', 'iframeTabAction','$state', '$stateParams', "SIE.JS", 'httpServer',function saafTableController($scope, URLAPI, $rootScope,iframeTabAction, $state, $stateParams,JS, httpServer) {
        $scope.dataTable = {}
