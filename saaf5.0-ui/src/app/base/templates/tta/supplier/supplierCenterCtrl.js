...
define(['app', 'pinyin', 'ztree'], function (app, pinyin, ztree) {
    app.controller('supplierCenterCtrl', function ($scope, $filter, $location, $rootScope, $state, $stateParams, SIEJS, httpServer, URLAPI, iframeTabAction, setNewRow) {

        $scope.params = {}
        $scope.logoImg = []

        $scope.btnNew = function () {
            iframeTabAction('新增供应商', 'supplierDetail/')
        }
        ...
        $scope.btnModify = function () {
            ...
            iframeTabAction('供应商详情：'+row.supplierName, 'supplierDetail/' + row.supplierId)
        }
        //图片添加执行方法
