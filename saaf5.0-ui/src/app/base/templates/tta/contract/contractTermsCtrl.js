...
define(['app','jqueryUi','jqprint','layui'], function (app,jqueryUi,jqprint,layui) {
    ...
    app.controller('contractTermsCtrl', function ($http, $scope, $filter, $location, $rootScope, $state, $stateParams, SIEJS, httpServer, URLAPI, iframeTabAction, setNewRow,dragTable,$timeout,validateForm,$compile,tableXlsExport) {
