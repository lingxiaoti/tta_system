...
define(['app', 'pinyin', 'ztree','XLSX'], function (app, pinyin, ztree,XLSX) {
    app.controller('ttaPogSpaceLineCtrl', function ($scope, $filter, $location, $rootScope, $state, $stateParams, SIEJS, httpServer, URLAPI, iframeTabAction, setNewRow,$http) {
        ...
        $scope.daoru = function () {
            $('#excelTtaPogSpaceLine').modal('toggle');
            $scope.buttonFlag = true ;
        }
        ...
        $scope.save = function (invalid) {
            ...
            $http.post(URLAPI.saveImportPogInfo, fd, {
