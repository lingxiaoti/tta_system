...
define(['app'], function (app) {
    app.controller('msgLogCtrl', function ($scope, $location, $rootScope, $state, $stateParams, SIEJS,msgLogDel) {
        $scope.restore=function(){
            $scope.params={
                creationDateEnd:$rootScope.$getToday(0),
                creationDateStart:$rootScope.$getToday(-7),
            };
        };
        $scope.restore();
