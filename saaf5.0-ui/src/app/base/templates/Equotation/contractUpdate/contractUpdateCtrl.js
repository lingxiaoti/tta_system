...
define(["app"], function (app) {
    app.controller('contractUpdateCtrl', ['$scope', '$state','URLAPI','$stateParams', 'iframeTabAction', "SIE.JS", 'httpServer', function ($scope, $state,URLAPI,$stateParams,iframeTabAction, JS, httpServer) {
        $scope.dataTable = {};
        ...
        $scope.btnNew = function () {
            iframeTabAction('年度Commercial contract审核导入更新新增', 'editContractUpdate/')
        };

        $scope.toEditHtml = function (row) {
            iframeTabAction('年度Commercial contract审核导入更新', 'editContractUpdate/'+row.updateHeadId)
        };
