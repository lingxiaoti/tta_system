...
define(["app"], function (app) {
    app.controller('spendUpdateCtrl', ['$scope', '$state','URLAPI','$stateParams', 'iframeTabAction', "SIE.JS", 'httpServer', function ($scope, $state,URLAPI,$stateParams,iframeTabAction, JS, httpServer) {
        $scope.dataTable = {};
        ...
        $scope.btnNew = function () {
            iframeTabAction('年度Supplier spend profile审核导入更新新增', 'editSpendUpdate/')
        };

        $scope.toEditHtml = function (row) {
            iframeTabAction('年度Supplier spend profile审核导入更新', 'editSpendUpdate/'+row.updateHeadId)
        };
