...
define(["app"], function (app) {
    app.controller('scoreUpdateCtrl', ['$scope', '$state','URLAPI','$stateParams', 'iframeTabAction', "SIE.JS", 'httpServer', function ($scope, $state,URLAPI,$stateParams,iframeTabAction, JS, httpServer) {
        $scope.dataTable = {};
        ...
        $scope.btnNew = function () {
            iframeTabAction('年度评分审核导入更新新增', 'editScoreUpdate/')
        };

        $scope.toEditHtml = function (row) {
            iframeTabAction('年度评分审核导入更新', 'editScoreUpdate/'+row.updateHeadId)
        };
